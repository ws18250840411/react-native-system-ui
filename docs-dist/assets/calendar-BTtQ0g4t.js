import{R as p,j as e}from"./main-CX5QgiXt.js";import{C as E}from"./Calendar-Cg8-8G06.js";import{C as h}from"./index-D361XNui.js";import{T as A}from"./index-BUHqkOou.js";import"./Popup-DLZFaqRn.js";import"./createPlatformShadow-BbOkyb5V.js";import"./IconBase-D_kjvpJY.js";import"./Portal-BtmwX5Pt.js";import"./Overlay-uC1_KEGM.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./createComponentTokensHook-Hc3l7riF.js";import"./Animated-rPtBS5kg.js";import"./index-BEnr4R_B.js";import"./index-CTcRCRb2.js";import"./index-BDzwQtXM.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-CF7tueuh.js";import"./useAriaPress-sIRcrStb.js";import"./index-4qDXDIEs.js";import"./index-CQ2P49YQ.js";import"./SafeAreaView-DiARkPwI.js";import"./useSafeAreaPadding-Du1CT4G_.js";import"./useControllableValue-wnptCJgI.js";import"./Arrow-CFMZgj_G.js";import"./hairline-6DGjxZ3L.js";import"./Loading-Dy4Xe7Yb.js";import"./index-quLIWFrm.js";import"./Checked-C5Dq4Yeg.js";import"./Close-D6NXA1XS.js";const m=n=>n&&(Array.isArray(n)?n.map(l=>new Date(l)):new Date(n)),O=(n,l)=>n?l==="single"?n instanceof Date?n.toLocaleDateString():"请选择日期":l==="multiple"?Array.isArray(n)&&n.length?`共${n.length}个日期`:"请选择日期":Array.isArray(n)&&n.length===2?`${n[0].toLocaleDateString()} ~ ${n[1].toLocaleDateString()}`:"请选择日期":"请选择日期",r=n=>{const{key:l,title:t,type:a="single",showConfirm:i,cellProps:u,initialValue:y,valueFormatter:o,onChange:s,...j}=n,[k,D]=p.useState(!1),[C,V]=p.useState(()=>m(y??null)),[L,f]=p.useState(null),g=i??a!=="single",v=p.useCallback(d=>{f(d?m(C):null),D(d)},[C]),S=p.useCallback(d=>{const c=m(d);f(c),g||(V(c),s?.(c,a))},[g,s,a]),w=p.useCallback(d=>{const c=m(d);V(c),s?.(c,a)},[s,a]),F=o?o(C,a):O(C,a),P=L??C;return{cell:e.jsx(h,{title:t,value:F,isLink:!0,onPress:()=>v(!0),...u},`cell-${l}`),calendar:e.jsx(E,{...j,poppable:!0,type:a,visible:k,value:P??null,showConfirm:g,onVisibleChange:v,onSelect:S,onConfirm:w},`calendar-${l}`)}},x=()=>{const n=r({key:"basic-single",title:"单个日期",showConfirm:!1}),l=r({key:"basic-multiple",title:"多个日期",type:"multiple"}),t=r({key:"basic-range",title:"日期区间",type:"range",cellProps:{titleStyle:{width:96}}}),a=[n,l,t];return e.jsxs(e.Fragment,{children:[e.jsx(h.Group,{title:"基础",card:!0,children:a.map(i=>i.cell)}),a.map(i=>i.calendar)]})},M=`import React from 'react'
