import{j as e,R as r,V as b}from"./main-CC2DK3OK.js";import{P as i}from"./Picker-BzpxbIBG.js";import{T as u}from"./index-CYc3exVx.js";import"./Loading-_9EKEhr2.js";import"./createComponentTokensHook-BcXZOvON.js";import"./index-BnjI8SiS.js";import"./extends-CF3RwP-h.js";import"./color-BplLcdBL.js";import"./number-BG570ZaL.js";import"./index-CJrLMJTa.js";import"./index-CN-rk8sC.js";import"./compare-B0QhPEQa.js";import"./index-Cakcz3d2.js";import"./index-CCOraIhd.js";import"./Portal-D9I31KH1.js";import"./Checked-BJm2Hkef.js";import"./IconBase-BNmvoXvm.js";import"./Close-BKbx2ovl.js";import"./index-BP7Blb5n.js";import"./Animated-C-b5K9fC.js";import"./index-D_JlQYPg.js";import"./SafeAreaView-CgItGtgs.js";import"./useSafeAreaPadding-B0opQgwg.js";import"./useOverlayStack-xa377Hoz.js";import"./animation-BpxpeSKC.js";import"./useAriaPress-DVn62gIQ.js";const f=[{label:"南京",value:0},{label:"苏州",value:1},{label:"常州",value:2},{label:"淮安",value:3},{label:"扬州",value:4},{label:"南通",value:5},{label:"宿迁",value:6},{label:"泰州",value:7},{label:"无锡",value:8},{label:"长沙",value:9}];function s(){return e.jsx(i,{title:"基础使用",columns:f,defaultValue:0,onChange:n=>{u.info(`选中值: ${n[0]}`)},onCancel:()=>u.info("点击取消按钮"),onConfirm:()=>u.info("点击确认按钮")})}const P=`import React from 'react'
...
`}},title:"基础用法",identifier:"picker-basic",lang:"tsx",meta:{title:"基础用法"}},a=n=>n.map(t=>({label:t,value:t})),c=[a(["周一","周二","周三","周四","周五"]),a(["上午","下午","晚上"])];function d(){const[n,t]=r.useState(["周二","晚上"]);return e.jsx(b,{children:e.jsx(i,{columns:c,value:n,onChange:l=>{const m=c.map((v,p)=>v.findIndex(j=>j.value===l[p]));u.info(`当前值：${l}，当前索引：${m}`),t(l)}})})}const F=`import React from 'react'
import { Picker, Toast, type PickerOption } from 'react-native-system-ui'
...
`}},title:"多列",identifier:"picker-multi",lang:"tsx",meta:{title:"多列"}},C=[{label:"江苏",value:"1",children:[{label:"苏州",value:"1-1",children:[{label:"姑苏区",value:"1-1-1"},{label:"吴中区",value:"1-1-2"}]},{label:"扬州",value:"1-2",children:[{label:"广陵区",value:"1-2-1"},{label:"邗江区",value:"1-2-2"}]}]},{label:"浙江",value:"2",children:[{label:"杭州",value:"2-1",children:[{label:"西湖区",value:"2-1-1"},{label:"余杭区",value:"2-1-2"}]},{label:"温州",value:"2-2",children:[{label:"鹿城区",value:"2-2-1"},{label:"瓯海区",value:"2-2-2"}]}]}];function x(){const[n,t]=r.useState(["2","2-2","2-2-2"]);return e.jsx(i,{columns:C,value:n,onChange:t})}const A=`import React from 'react'
...
`}},title:"级联选择",identifier:"picker-cascade",lang:"tsx",meta:{title:"级联选择"}},o=[{label:"8:00",value:"0800"},{label:"9:00",value:"0900"},{label:"10:00",value:"1000"}];function h(){return e.jsx(i,{title:"会议时间",columns:o,defaultValue:"0800",confirmButtonText:"完成",cancelButtonText:"返回",toolbarPosition:"bottom",onChange:n=>{const t=o.findIndex(l=>l.value===n[0]);u.info(`选中值${n[0]}，索引: ${t}`)},onCancel:()=>u.info("点击取消按钮"),onConfirm:()=>u.info("点击确认按钮")})}const D=`import React from 'react'
import { Picker, Toast, type PickerOption } from 'react-native-system-ui'
...
`}},title:"基础用法",identifier:"picker-basic",lang:"tsx",meta:{title:"基础用法"}},{Component:d,key:"picker-multi",sources:{_:{tsx:`import React from 'react'
import { Picker, Toast, type PickerOption } from 'react-native-system-ui'
import { View } from 'react-native'
...
`}},title:"多列",identifier:"picker-multi",lang:"tsx",meta:{title:"多列"}},{Component:x,key:"picker-cascade",sources:{_:{tsx:`import React from 'react'
import { Picker } from 'react-native-system-ui'
...
`}},title:"级联选择",identifier:"picker-cascade",lang:"tsx",meta:{title:"级联选择"}},{Component:h,key:"picker-toolbar",sources:{_:{tsx:`import React from 'react'
import { Picker, Toast, type PickerOption } from 'react-native-system-ui'
