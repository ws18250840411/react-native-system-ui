import{r as w,c as n,j as e,V as o,a as c}from"./main-O6KZrSH_.js";import{S as fe}from"./ArrowLeft-DTdKniyP.js";import{c as pe}from"./hairline-Dpq7rEkb.js";import{c as me,T as v}from"./createComponentTokensHook-KzOuLm4c.js";import{M as I}from"./index-DvCZppP1.js";import{S as je}from"./SafeAreaView-L8uUXbhq.js";import{u as S}from"./useAriaPress-DMjZXFvR.js";import{S as ve}from"./Search--X5QcCEe.js";import"./IconBase-DZr7C-P7.js";import"./extends-CF3RwP-h.js";import"./useSafeAreaPadding-CsLe5OYH.js";import"./index-CJrLMJTa.js";class y{static alert(){}}const ye=({palette:r,spacing:x,fontSize:i})=>({defaults:{fixed:!1,placeholder:!1,border:!0,safeAreaInsetTop:!1,leftArrow:!1,zIndex:1},layout:{container:{width:"100%"},bar:{flexDirection:"row",alignItems:"center",minHeight:48,paddingHorizontal:x.md},center:{flex:1,alignItems:"center",justifyContent:"center",paddingHorizontal:12},side:{minWidth:60,flexDirection:"row",alignItems:"center",gap:4},rightAlign:{justifyContent:"flex-end"},sidePlaceholder:{minWidth:60},sideText:{fontSize:16},titleWrapper:{alignItems:"center"},title:{includeFontPadding:!1},description:{marginTop:2,includeFontPadding:!1},fixed:{position:"fixed",top:0,left:0,right:0}},colors:{background:"#ffffff",text:r.default[900],description:r.default[500],border:r.default[200],icon:r.default[700]},typography:{titleSize:i.lg,titleWeight:"600",descriptionSize:i.sm},sizing:{height:52}}),ge=me("navBar",ye),C=r=>{const{tokensOverride:x,title:i,description:d,children:F,leftText:l,rightText:s,leftIcon:E,rightIcon:k,leftArrow:z,fixed:_,placeholder:V,zIndex:H,border:W,safeAreaInsetTop:O,background:$,tintColor:g,titleStyle:q,descriptionStyle:G,sideStyle:f,onPressLeft:J,onClickLeft:K,onPressRight:Q,onClickRight:U,style:X,...Y}=r,t=ge(x),A=z??t.defaults.leftArrow,B=_??t.defaults.fixed,Z=V??t.defaults.placeholder,ee=H??t.defaults.zIndex,te=W??t.defaults.border,P=O??B,N=$??t.colors.background,p=J??K,m=Q??U,[re,ie]=w.useState(t.sizing.height),b=B&&Z,T=w.useCallback(u=>{if(!b)return;const a=u.nativeEvent.layout.height;ie(h=>Math.abs(h-a)<.5?h:a)},[b]),ne=g??t.colors.text,j=g??t.colors.icon,oe=c(l)?String(l):"返回",le=c(s)?String(s):"操作",se=S({disabled:!p,onPress:p,extraProps:{accessibilityRole:"button",accessibilityLabel:oe}}),ae=S({disabled:!m,onPress:m,extraProps:{accessibilityRole:"button",accessibilityLabel:le}}),ce=()=>{const u=A===!0?e.jsx(fe,{size:18,fill:j,color:j}):n(A)&&A;if(!(!!p||n(u)||n(l)||n(E)))return e.jsx(o,{style:t.layout.sidePlaceholder});const h=e.jsxs(e.Fragment,{children:[u,E,n(l)?c(l)?e.jsx(v,{numberOfLines:1,style:[t.layout.sideText,{color:j}],children:l}):l:null]});return p?e.jsx(I,{hitSlop:{top:8,right:8,bottom:8,left:8},testID:"rv-navbar-left",style:[t.layout.side,f],...se.interactionProps,children:h}):e.jsx(o,{testID:"rv-navbar-left",style:[t.layout.side,f],children:h})},de=()=>{if(!(!!m||n(s)||n(k)))return e.jsx(o,{style:t.layout.sidePlaceholder});const a=e.jsxs(e.Fragment,{children:[n(s)?c(s)?e.jsx(v,{numberOfLines:1,style:[t.layout.sideText,{color:j}],children:s}):s:null,k]});return m?e.jsx(I,{hitSlop:{top:8,right:8,bottom:8,left:8},testID:"rv-navbar-right",style:[t.layout.side,t.layout.rightAlign,f],...ae.interactionProps,children:a}):e.jsx(o,{testID:"rv-navbar-right",style:[t.layout.side,t.layout.rightAlign,f],children:a})},ue=n(F)?F:e.jsxs(o,{style:t.layout.titleWrapper,children:[n(i)?c(i)?e.jsx(v,{style:[t.layout.title,{color:ne,fontSize:t.typography.titleSize,fontWeight:t.typography.titleWeight},q],numberOfLines:1,children:i}):i:null,n(d)?c(d)?e.jsx(v,{style:[t.layout.description,{color:g??t.colors.description,fontSize:t.typography.descriptionSize},G],numberOfLines:1,children:d}):d:null]}),R=e.jsxs(o,{style:[t.layout.bar,{backgroundColor:N},te?pe(t.colors.border):null],onLayout:P?void 0:T,children:[ce(),e.jsx(o,{style:t.layout.center,children:ue}),de()]}),he=P?e.jsx(je,{onLayout:T,style:{backgroundColor:N},children:R}):R,xe=e.jsx(o,{...Y,style:[t.layout.container,B&&[t.layout.fixed,{zIndex:ee}],X],children:he});return e.jsxs(e.Fragment,{children:[b?e.jsx(o,{testID:"rv-navbar-placeholder",style:{height:re}}):null,xe]})};C.displayName="NavBar";const D=()=>e.jsx(o,{style:{height:120,backgroundColor:"#f4f5f7",margin:16,borderRadius:12}}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(C,{title:"标题",leftText:"返回",leftArrow:!0,rightText:"按钮",onClickLeft:()=>y.alert("点击返回"),onClickRight:()=>y.alert("点击按钮")}),e.jsx(D,{}),e.jsx(D,{})]}),Ae=`import React from 'react'
...
`}},dependencies:{react:{type:"NPM",value:">=18.0.0"},"react-native":{type:"NPM",value:">=0.72.0"},"react-native-system-icon":{type:"NPM",value:"1.0.2"},"react-native-system-ui":{type:"NPM",value:"0.0.6"},"@types/react":{type:"NPM",value:"^19.1.1"},"index.tsx":{type:"FILE",value:`import React from 'react'
import { Alert } from 'react-native'
import { Search as SearchIcon } from 'react-native-system-icon'
