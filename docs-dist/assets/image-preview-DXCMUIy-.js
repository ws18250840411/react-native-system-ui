import{R as y,r as o,d as Be,j as e,V as I,s as Te,$ as Ge}from"./main-O6KZrSH_.js";import{C as c}from"./index-DCx-GaLs.js";import{P as Me}from"./Popup-DvjP5SkZ.js";import{S}from"./index-CEi_CMAE.js";import{c as _e,T as re}from"./createComponentTokensHook-KzOuLm4c.js";import{M as $e}from"./index-DvCZppP1.js";import{I as Se}from"./index-C_v13XD0.js";import{P as V}from"./Portal-D2qUv7UW.js";import{S as ne}from"./Close-DpyqkEOI.js";import{T as Ne}from"./index-CCLXK9-u.js";import"./Arrow-r8D7M_Tx.js";import"./IconBase-DZr7C-P7.js";import"./hairline-Dpq7rEkb.js";import"./useAriaPress-DMjZXFvR.js";import"./index-CJrLMJTa.js";import"./createPlatformShadow-BbOkyb5V.js";import"./Animated-qBs3E5U6.js";import"./extends-CF3RwP-h.js";import"./index--voB8Asl.js";import"./index-DcjI-aro.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-Tvvid2F1.js";import"./index-Cq_gACMg.js";import"./SafeAreaView-L8uUXbhq.js";import"./useSafeAreaPadding-CsLe5OYH.js";import"./number-BcSDXImJ.js";import"./Overlay-CmwAk_J5.js";import"./Loading-CdSfkQu4.js";import"./index-ANZ1PvOD.js";import"./Checked-Cm5uhjGy.js";const Ve=n=>{const{palette:t,radii:l,fontSize:u,spacing:d}=n;return{colors:{background:"rgba(0,0,0,0.95)",indexBackground:"rgba(0,0,0,0.35)",indexText:"#fff",indicatorActive:t.primary?.[500]??"#1989fa",indicatorInactive:"rgba(255,255,255,0.4)",transparent:"transparent"},spacing:{indexTop:24,indexPaddingHorizontal:d.lg,indexPaddingVertical:d.xs},layout:{popupPadding:0,popupRadius:0},radii:{indexBadge:l.pill},typography:{indexTextSize:u.sm}}},Oe=_e("imagePreview",Ve),v=(n,t)=>t<=0?0:Math.max(0,Math.min(t-1,n)),te=8,se=te*te,He=y.memo(n=>{const{source:t,rendered:l,pressableHandlers:u}=n;return e.jsx($e,{style:m.slidePressable,...u,children:l?e.jsx(Se,{source:t,resizeMode:"contain",style:m.image}):e.jsx(I,{style:m.imagePlaceholder})})},(n,t)=>n.source===t.source&&n.rendered===t.rendered&&n.pressableHandlers===t.pressableHandlers),O=y.forwardRef((n,t)=>{const{visible:l,images:u=[],startPosition:d=0,swipeDuration:H=300,tokensOverride:D,lazyRender:C=!1,lazyRenderBuffer:me=1,showIndex:X=!0,indexRender:L,showIndicators:ge=!1,closeable:xe=!1,closeIcon:he,closeIconPosition:fe="top-right",closeOnlyClickCloseIcon:A=!1,overlay:ve=!0,overlayStyle:je,closeOnBackPress:ye,closeOnPopstate:Ce,zIndex:Pe,duration:Ie,safeAreaInsetTop:we=!0,safeAreaInsetBottom:Ee=!0,onChange:Y,onClose:W,onClosed:Re,beforeClose:q}=n,{colors:x,layout:U,radii:K,typography:Q,spacing:f}=Oe(D),B=o.useRef(null),J=o.useRef("close"),E=o.useRef(null),R=o.useRef(!1),p=u.length,[Fe,F]=o.useState(()=>v(d,p)),P=v(Fe,p),T=o.useRef({images:u,index:P,beforeClose:q,onClose:W});T.current={images:u,index:P,beforeClose:q,onClose:W};const ze=o.useMemo(()=>u.map(s=>Be(s)?{uri:s}:s),[u]);o.useEffect(()=>{F(s=>v(s,p))},[p]),o.useEffect(()=>{if(!l)return;const s=v(d,p);if(F(s),typeof requestAnimationFrame<"u"){const r=requestAnimationFrame(()=>{B.current?.swipeTo(s,!1)});return()=>cancelAnimationFrame(r)}},[p,d,l]);const z=o.useCallback(async s=>{const{beforeClose:r,images:i,index:a}=T.current;return r?await r({reason:s,index:a,image:i[a]})!==!1:!0},[]),k=o.useCallback(async(s,r=!1)=>{const{onClose:i,images:a,index:g}=T.current;!r&&!await z(s)||i?.({index:g,image:a[g]})},[z]),ke=o.useCallback(async s=>{const r=s==="close-icon"?"close-icon":s==="overlay"?"overlay":"close";return J.current=r,z(r)},[z]),be=o.useCallback(()=>{k(J.current,!0)},[k]);o.useImperativeHandle(t,()=>({swipeTo:(s,r=!0)=>{const i=v(s,p);F(i),B.current?.swipeTo(i,r)}}),[p]);const De=o.useCallback(s=>{P!==s&&(F(s),Y?.(s))},[Y,P]),Z=o.useCallback(()=>{A||k("content")},[A,k]),b=o.useCallback(()=>{E.current=null,R.current=!1},[]),G=o.useCallback((s,r)=>{E.current={x:s,y:r},R.current=!1},[]),M=o.useCallback((s,r)=>{const i=E.current;if(!i)return;const a=s-i.x,g=r-i.y;a*a+g*g>=se&&(R.current=!0)},[]),_=o.useCallback((s,r)=>{const i=E.current,a=R.current;if(b(),!i||a)return;const g=s-i.x,$=r-i.y;g*g+$*$>=se||Z()},[Z,b]),Le=o.useMemo(()=>{const s={onTouchStart:r=>{const{pageX:i,pageY:a}=r.nativeEvent;i!=null&&a!=null&&G(i,a)},onTouchMove:r=>{const{pageX:i,pageY:a}=r.nativeEvent;i!=null&&a!=null&&M(i,a)},onTouchEnd:r=>{const{pageX:i,pageY:a}=r.nativeEvent;i!=null&&a!=null&&_(i,a)},onTouchCancel:b};return s.onMouseDown=r=>{const i=r.nativeEvent;i?.pageX!=null&&i?.pageY!=null&&G(i.pageX,i.pageY)},s.onMouseMove=r=>{const i=r.nativeEvent;i?.buttons===1&&i?.pageX!=null&&i?.pageY!=null&&M(i.pageX,i.pageY)},s.onMouseUp=r=>{const i=r.nativeEvent;i?.pageX!=null&&i?.pageY!=null&&_(i.pageX,i.pageY)},s},[M,G,b,_]),ee=o.useCallback((s,r)=>{if(!X||r===0)return null;const i=`${s+1} / ${r}`;return e.jsx(I,{style:[m.index,{top:f.indexTop}],testID:"rv-image-preview-index",children:e.jsx(I,{style:[m.indexBadge,{backgroundColor:x.indexBackground,borderRadius:K.indexBadge,paddingHorizontal:f.indexPaddingHorizontal,paddingVertical:f.indexPaddingVertical}],children:L?L({index:s,len:r}):e.jsx(re,{style:[m.indexText,{color:x.indexText,fontSize:Q.indexTextSize}],children:i})})})},[x.indexBackground,x.indexText,L,K.indexBadge,X,f.indexPaddingHorizontal,f.indexPaddingVertical,f.indexTop,Q.indexTextSize]),Ae=C?Math.max(0,me|0):0;return e.jsx(Me,{visible:l,overlay:ve,overlayStyle:je,closeOnOverlayPress:!A,closeOnBackPress:ye,closeOnPopstate:Ce,zIndex:Pe,duration:Ie,closeable:xe,closeIcon:he,closeIconPosition:fe,stopPropagation:!1,round:!1,safeAreaInsetTop:we,safeAreaInsetBottom:Ee,overlayTestID:"rv-image-preview-overlay",style:[m.popup,{backgroundColor:x.transparent,padding:U.popupPadding,borderRadius:U.popupRadius}],beforeClose:ke,onClose:be,onClosed:Re,children:e.jsxs(I,{style:[m.content,{backgroundColor:x.background}],children:[p===1?ee(0,1):null,p===0?e.jsx(I,{style:m.empty,testID:"rv-image-preview-empty"}):e.jsx(S,{ref:B,style:m.swiper,initialSwipe:v(d,p),loop:!1,autoplay:!1,touchable:p>1,indicator:(s,r)=>e.jsxs(e.Fragment,{children:[ee(r,s),ge&&s>1&&e.jsx(S.PagIndicator,{total:s,current:r,activeColor:x.indicatorActive,inactiveColor:x.indicatorInactive,style:{bottom:32},testID:"rv-image-preview-indicators"})]}),onChange:De,testID:"rv-image-preview-swiper",children:ze.map((s,r)=>e.jsx(S.Item,{style:m.slide,testID:`rv-image-preview-slide-${r}`,children:e.jsx(He,{source:s,rendered:!C||Math.abs(r-P)<=Ae,pressableHandlers:Le})},r))})]})})});O.displayName="ImagePreview";const m=Te.create({popup:{position:"absolute",top:0,left:0,right:0,bottom:0,width:"100%",height:"100%",maxWidth:"100%",maxHeight:"100%"},content:{flex:1},swiper:{flex:1},slide:{justifyContent:"center",alignItems:"center",flex:1},slidePressable:{flex:1,width:"100%",height:"100%",justifyContent:"center",alignItems:"center"},image:{width:"100%",height:"100%"},imagePlaceholder:{width:"100%",height:"100%"},empty:{flex:1},index:{position:"absolute",left:0,right:0,alignItems:"center",zIndex:1},indexBadge:{},indexText:{fontWeight:"500"}}),j=new Set,w=new Map,oe=n=>{V.remove(n),j.delete(n),w.delete(n)},N=n=>{const t=w.get(n);if(t){t();return}oe(n)},Xe=({id:n,options:t})=>{const[l,u]=o.useState(!0),d=o.useCallback(()=>{u(!1)},[]);o.useEffect(()=>(w.set(n,d),()=>{w.get(n)===d&&w.delete(n)}),[d,n]);const H=o.useCallback(C=>{t.onClose?.(C),u(!1)},[t]),D=o.useCallback(()=>{t.onClosed?.(),oe(n)},[n,t]);return e.jsx(O,{...t,visible:l,onClose:H,onClosed:D})},ie={open:(n={})=>{j.forEach(l=>N(l)),j.clear();const t=V.add(null);return j.add(t),V.update(t,e.jsx(Xe,{id:t,options:n})),()=>N(t)},clear:()=>{j.forEach(n=>N(n)),j.clear()}},Ye=Object.assign(O,{Host:Ge,open:ie.open,clear:ie.clear}),h=Ye,We=["https://img.yzcdn.cn/vant/apple-1.jpg","https://img.yzcdn.cn/vant/apple-2.jpg","https://img.yzcdn.cn/vant/apple-3.jpg"],le=()=>e.jsx(c.Group,{children:e.jsx(c,{title:"预览图片",isLink:!0,onPress:()=>h.open({images:We,onChange:n=>console.log(`当前展示第${n+1}张`)})})}),qe=`import React from 'react'
