...
`,An={code:Sn,sources:{_:{tsx:`import React from 'react'
import { Cascader, Field, type CascaderOption, type CascaderValue } from 'react-native-system-ui'
...
export default options
`}},title:"基础用法",identifier:"cascader-base",lang:"tsx",meta:{title:"基础用法"}},Tn=n=>n.map(t=>t?.text).filter(Boolean).join(" / ");function Oe(){const n=Z.useForm(),t=()=>{n.current?.setFieldsValue({area:["330000","330100","330104"]})};return e.jsxs(Z,{ref:n,style:{paddingHorizontal:12},onFinish:a=>Fn.info(JSON.stringify(a)),children:[e.jsx(Z.Item,{name:"area",trigger:"onChange",children:e.jsx(P,{poppable:!0,popupRound:!0,title:"请选择地区",options:ne,children:(a,c,r)=>e.jsx(_,{label:"地区",readOnly:!0,isLink:!0,value:Tn(c),placeholder:"请选择地区",onClick:r.open})})}),e.jsxs(bn,{justify:"center",style:{marginTop:20},children:[e.jsx(ee,{type:"primary",text:"提交",onPress:()=>n.current?.submit()}),e.jsx(ee,{text:"设置默认值",onPress:t})]})]})}const kn=`import React from 'react'
...
`,Nn={code:kn,sources:{_:{tsx:`import React from 'react'
import { Button, Cascader, Field, Form, Space, Toast, type CascaderOption } from 'react-native-system-ui'
...
export default options
`}},title:"Form中使用",identifier:"cascader-form",lang:"tsx",meta:{title:"Form中使用"}},_n=n=>n.map(t=>t?.text).filter(Boolean).join(" / ");function Ve(){const[n,t]=F.useState([{text:"浙江省",value:"330000",children:[]}]),[a,c]=F.useState([]),r=d=>{const u=String(d[d.length-1]??""),l=n[0].children?.length===0;u===String(n[0].value)&&l&&setTimeout(()=>{t(C=>{const x=[...C];return x[0]={...x[0],children:[{text:"杭州市",value:"330100"},{text:"宁波市",value:"330200"}]},x})},800)};return e.jsx(P,{poppable:!0,popupRound:!0,title:"请选择地区",options:n,value:a,onChange:d=>{c(d),r(d)},children:(d,u,l)=>e.jsx(_,{label:"地区",isLink:!0,readOnly:!0,value:_n(u),placeholder:"请选择地区",onClick:l.open})})}const Ln=`import React from 'react'
import { Cascader, Field, type CascaderOption, type CascaderValue } from 'react-native-system-ui'
...
`,In={code:Ln,sources:{_:{tsx:`import React from 'react'
import { Cascader, Field, type CascaderOption, type CascaderValue } from 'react-native-system-ui'
...
`}},title:"异步加载选项",identifier:"cascader-async",lang:"tsx",meta:{title:"异步加载选项"}},zn=[{label:"浙江省",code:"330000",items:[{label:"杭州市",code:"330100"}]},{label:"江苏省",code:"320000",items:[{label:"南京市",code:"320100"}]}],Ee={text:"label",value:"code",children:"items"},Hn=n=>n.map(t=>t?.[Ee.text]).filter(Boolean).join(" / ");function Be(){return e.jsx(P,{poppable:!0,popupRound:!0,fieldNames:Ee,title:"请选择地区",options:zn,children:(n,t,a)=>e.jsx(_,{label:"地区",isLink:!0,readOnly:!0,value:Hn(t),placeholder:"请选择地区",onClick:a.open})})}const Mn=`import React from 'react'
...
`}},title:"自定义字段名",identifier:"cascader-fieldnames",lang:"tsx",meta:{title:"自定义字段名"}},Wn=n=>n.map(t=>t?.text).filter(Boolean).join(" / ");function Re(){const[n,t]=F.useState([]);return e.jsxs(e.Fragment,{children:[e.jsx(P,{poppable:!0,popupRound:!0,title:"请选择地区",options:ne,value:n,onFinish:a=>t(a),children:(a,c,r)=>e.jsx(_,{label:"地区",isLink:!0,readOnly:!0,value:Wn(c),placeholder:"请选择地区",onClick:r.open})}),e.jsx(ee,{type:"primary",size:"small",style:{marginTop:12,alignSelf:"center",width:"90%"},text:"外部设置",onPress:()=>t(["330000","330100","330104"])})]})}const $n=`import React from 'react'
...
export default options
`}},title:"受控组件",identifier:"cascader-value",lang:"tsx",meta:{title:"受控组件"}}],Gn={simulator:{compact:!0}},Qn=[{depth:1,text:"Cascader 级联选择",id:"cascader-级联选择"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"Form中使用",id:"form中使用"},{depth:3,text:"异步加载选项",id:"异步加载选项"},{depth:3,text:"自定义字段名",id:"自定义字段名"},{depth:3,text:"受控组件",id:"受控组件"},{depth:2,text:"API",id:"api"},{depth:3,text:"Props",id:"props"},{depth:3,text:"Events",id:"events"},{depth:3,text:"CascaderOption 数据结构",id:"cascaderoption-数据结构"},{depth:2,text:"主题定制",id:"主题定制"},{depth:3,text:"样式变量",id:"样式变量"}],Xn="/docs/components/cascader.md",Yn="Cascader 级联选择",Zn="1769570039000",Wt=n=>n.children({MdContent:Jn,demos:Un,frontmatter:Gn,slugs:Qn,filePath:Xn,title:Yn,updatedTime:Zn});export{Jn as MdContent,Wt as default,Un as demos,Xn as filePath,Gn as frontmatter,Qn as slugs,Yn as title,Zn as updatedTime};
