import{j as e}from"./main-CC2DK3OK.js";import{C as t}from"./index-Dueh9AzQ.js";import{I as m}from"./Image-B67890TJ.js";import{S as h,a as j}from"./LocationO-BkQZoSYj.js";import{S as v}from"./ShopO-DWTgWPmv.js";import{T as f}from"./createComponentTokensHook-BcXZOvON.js";import"./Arrow-CP2eQgBg.js";import"./IconBase-BNmvoXvm.js";import"./hairline-Bq3nniT3.js";import"./index-CN-rk8sC.js";import"./extends-CF3RwP-h.js";import"./useAriaPress-DVn62gIQ.js";import"./index-CJrLMJTa.js";import"./index-D_JlQYPg.js";import"./index-CCOraIhd.js";import"./index-BnjI8SiS.js";function i(){return e.jsxs(t.Group,{children:[e.jsx(t,{title:"单元格",value:"内容"}),e.jsx(t,{title:"单元格",value:"内容",label:"描述信息"})]})}const F=`import React from 'react'
...
`}},title:"基础用法",identifier:"cell-base",lang:"tsx",meta:{title:"基础用法"}};function n(){return e.jsx(t.Group,{children:Array.from({length:4}).map((r,u)=>e.jsx(t,{center:!0,title:`Avatar ${u}`,label:"Deserunt dolor",icon:e.jsx(m,{src:"https://img.yzcdn.cn/vant/apple-1.jpg",width:44,height:44,round:!0}),isLink:!0},u))})}const y=`import React from 'react'
...
`}},title:"用户列表",identifier:"cell-list",lang:"tsx",meta:{title:"用户列表"}};function o(){return e.jsxs(t.Group,{children:[e.jsx(t,{title:"单元格",value:"内容",size:"large"}),e.jsx(t,{title:"单元格",value:"内容",label:"描述信息",size:"large"})]})}const B=`import React from 'react'
...
`}},title:"单元格大小",identifier:"cell-size",lang:"tsx",meta:{title:"单元格大小"}};function c(){return e.jsxs(t.Group,{children:[e.jsx(t,{title:"单元格",icon:e.jsx(h,{})}),e.jsx(t,{title:"单元格",icon:e.jsx(j,{})})]})}const A=`import React from 'react'
...
`,g={code:A,sources:{_:{tsx:`import React from 'react'
...
`}},title:"展示图标",identifier:"cell-icon",lang:"tsx",meta:{title:"展示图标"}};function s(){return e.jsx(t.Group,{children:e.jsx(t,{value:"内容"})})}const P=`import React from 'react'
import { Cell } from 'react-native-system-ui'
...
`}},title:"只设置 value",identifier:"cell-value",lang:"tsx",meta:{title:"只设置 value"}};function a(){return e.jsxs(t.Group,{children:[e.jsx(t,{title:"单元格",isLink:!0}),e.jsx(t,{title:"单元格",isLink:!0,value:"内容"}),e.jsx(t,{title:"单元格",isLink:!0,arrowDirection:"down",value:"内容"})]})}const R=`import React from 'react'

import { Cell } from 'react-native-system-ui'

export default function CellArrowDemo() {
  return (
  <Cell.Group>
...
`}},title:"展示箭头",identifier:"cell-arrow",lang:"tsx",meta:{title:"展示箭头"}};function d(){return e.jsxs(e.Fragment,{children:[e.jsx(t.Group,{title:"分组1",children:e.jsx(t,{title:"单元格",value:"内容"})}),e.jsx(t.Group,{title:"分组2",children:e.jsx(t,{title:"单元格",value:"内容"})})]})}const M=`import React from 'react'
...
`}},title:"分组标题",identifier:"cell-group",lang:"tsx",meta:{title:"分组标题"}};function p(){return e.jsxs(t.Group,{card:!0,children:[e.jsx(t,{title:"单元格",value:"内容"}),e.jsx(t,{title:"单元格",value:"内容"})]})}const b=`import React from 'react'
...
`}},title:"卡片类型",identifier:"cell-card",lang:"tsx",meta:{title:"卡片类型"}};function x(){return e.jsx(t.Group,{children:e.jsx(t,{title:"单元格",icon:e.jsx(v,{}),children:e.jsx(f,{children:"自定义内容"})})})}const w=`import React from 'react'
...
`}},title:"自定义内容",identifier:"cell-children",lang:"tsx",meta:{title:"自定义内容"}};function C(){return e.jsx(t.Group,{children:e.jsx(t,{center:!0,title:"单元格",value:"内容",label:"描述信息"})})}const S=`import React from 'react'
import { Cell } from 'react-native-system-ui'
...
`}},title:"用户列表",identifier:"cell-list",lang:"tsx",meta:{title:"用户列表"}},{Component:o,key:"cell-size",sources:{_:{tsx:`import React from 'react'
...
`}},title:"单元格大小",identifier:"cell-size",lang:"tsx",meta:{title:"单元格大小"}},{Component:c,key:"cell-icon",sources:{_:{tsx:`import React from 'react'
...
`}},title:"自定义内容",identifier:"cell-children",lang:"tsx",meta:{title:"自定义内容"}},{Component:C,key:"cell-vertical",sources:{_:{tsx:`import React from 'react'
import { Cell } from 'react-native-system-ui'
...
`}},title:"垂直居中",identifier:"cell-vertical",lang:"tsx",meta:{title:"垂直居中"}}],T={simulator:{compact:!0}},V=[{depth:1,text:"Cell 单元格",id:"cell-单元格"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"用户列表",id:"用户列表"},{depth:3,text:"单元格大小",id:"单元格大小"},{depth:3,text:"展示图标",id:"展示图标"},{depth:3,text:"只设置 value",id:"只设置-value"},{depth:3,text:"展示箭头",id:"展示箭头"},{depth:3,text:"分组标题",id:"分组标题"},{depth:3,text:"卡片类型",id:"卡片类型"},{depth:3,text:"自定义内容",id:"自定义内容"},{depth:3,text:"垂直居中",id:"垂直居中"},{depth:2,text:"API",id:"api"},{depth:3,text:"CellGroup Props",id:"cellgroup-props"},{depth:3,text:"Cell Props",id:"cell-props"},{depth:3,text:"事件",id:"事件"},{depth:2,text:"差异说明",id:"差异说明"}],q="/docs/components/cell.md",H="Cell 单元格",J="1770373480000",se=r=>r.children({MdContent:z,demos:$,frontmatter:T,slugs:V,filePath:q,title:H,updatedTime:J});export{z as MdContent,se as default,$ as demos,q as filePath,T as frontmatter,V as slugs,H as title,J as updatedTime};
