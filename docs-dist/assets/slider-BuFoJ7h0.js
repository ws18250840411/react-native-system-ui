import{R as a,j as e,V as d,s as A}from"./main-CC2DK3OK.js";import{S as u}from"./Slider-DVgyzboI.js";import{T as i}from"./index-CYc3exVx.js";import{T as g}from"./createComponentTokensHook-BcXZOvON.js";import"./useAriaPress-DVn62gIQ.js";import"./index-CJrLMJTa.js";import"./useLabel-FqIItfPo.js";import"./number-BG570ZaL.js";import"./index-CN-rk8sC.js";import"./extends-CF3RwP-h.js";import"./Portal-D9I31KH1.js";import"./Loading-_9EKEhr2.js";import"./index-BnjI8SiS.js";import"./Checked-BJm2Hkef.js";import"./IconBase-BNmvoXvm.js";import"./Close-BKbx2ovl.js";import"./index-BP7Blb5n.js";import"./index-CCOraIhd.js";import"./Animated-C-b5K9fC.js";import"./index-Cakcz3d2.js";import"./index-D_JlQYPg.js";import"./SafeAreaView-CgItGtgs.js";import"./useSafeAreaPadding-B0opQgwg.js";import"./useOverlayStack-xa377Hoz.js";import"./animation-BpxpeSKC.js";function c(){const[t,r]=a.useState(10);return e.jsx(u,{value:t,onChange:n=>r(n),onChangeAfter:n=>i.info(`值：${Array.isArray(n)?n.join(" ~ "):n}`)})}const S=`import React from 'react'
...
`}},title:"禁用",identifier:"slider-disabled",lang:"tsx",meta:{title:"禁用"}};function x(){const[t,r]=a.useState(10);return e.jsx(u,{step:10,value:t,onChange:n=>r(n),onChangeAfter:n=>i.info(`值：${Array.isArray(n)?n.join(" ~ "):n}`)})}const B=`import React from 'react'
import { Slider, Toast } from 'react-native-system-ui'
...
`,T={code:B,sources:{_:{tsx:`import React from 'react'
import { Slider, Toast } from 'react-native-system-ui'
...
`}},title:"自定义样式",identifier:"slider-style",lang:"tsx",meta:{title:"自定义样式"}},l=A.create({button:{width:26,height:26,borderRadius:13,backgroundColor:"#ee0a24",alignItems:"center",justifyContent:"center"},text:{color:"#ffffff",fontSize:10,fontWeight:"600"}});function p(){const[t,r]=a.useState(10);return e.jsx(u,{buttonSize:26,button:({value:n})=>e.jsx(d,{style:l.button,children:e.jsx(g,{style:l.text,children:Array.isArray(n)?n[0]:n})}),value:t,onChange:n=>r(n),onChangeAfter:n=>i.info(`值：${Array.isArray(n)?n.join(" ~ "):n}`)})}const $=`import React from 'react'
