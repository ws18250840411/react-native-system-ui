import{R as a,j as e}from"./main-CC2DK3OK.js";import{C as l}from"./index-Dueh9AzQ.js";import{I as n}from"./Input-Bv44USdL.js";import{B as C}from"./index-BfHwmVBQ.js";import{T as g}from"./index-CYc3exVx.js";import"./Arrow-CP2eQgBg.js";import"./IconBase-BNmvoXvm.js";import"./createComponentTokensHook-BcXZOvON.js";import"./hairline-Bq3nniT3.js";import"./index-CN-rk8sC.js";import"./extends-CF3RwP-h.js";import"./useAriaPress-DVn62gIQ.js";import"./index-CJrLMJTa.js";import"./Field-DkY6Dtkh.js";import"./index-D03jSN7d.js";import"./useLocale-B4lUqsPR.js";import"./promise-DzoogS-n.js";import"./Close-BKbx2ovl.js";import"./Popup-G3cXoDWN.js";import"./createPlatformShadow-BbOkyb5V.js";import"./Portal-D9I31KH1.js";import"./Animated-C-b5K9fC.js";import"./index-Cakcz3d2.js";import"./index-CCOraIhd.js";import"./index-D_JlQYPg.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-xa377Hoz.js";import"./index-BP7Blb5n.js";import"./SafeAreaView-CgItGtgs.js";import"./useSafeAreaPadding-B0opQgwg.js";import"./index-BnjI8SiS.js";import"./index-CfGUJPQW.js";import"./color-BplLcdBL.js";import"./number-BG570ZaL.js";import"./Loading-_9EKEhr2.js";import"./Checked-BJm2Hkef.js";function o(){const[t,u]=a.useState({text:"",tel:"",digit:"",number:"",password:""}),r=i=>m=>u(j=>({...j,[i]:m}));return e.jsxs(l.Group,{children:[e.jsx(n,{value:t.text,onChangeText:r("text"),placeholder:"请输入文本",clearable:!0}),e.jsx(n,{value:t.tel,type:"tel",onChangeText:r("tel"),placeholder:"请输入手机号"}),e.jsx(n,{value:t.digit,type:"digit",onChangeText:r("digit"),placeholder:"请输入整数"}),e.jsx(n,{value:t.number,type:"number",onChangeText:r("number"),placeholder:"请输入数字"}),e.jsx(n,{value:t.password,type:"password",onChangeText:r("password"),placeholder:"请输入密码"})]})}const v=`import React from 'react'
...
`}},title:"基础用法",identifier:"input-basic",lang:"tsx",meta:{title:"基础用法"}};function s(){const[t,u]=a.useState("");return e.jsx(l.Group,{children:e.jsx(n,{placeholder:"请输入文本",value:t,onChangeText:u,clearable:!0,clearTrigger:"always"})})}const I=`import React from 'react'
import { Cell, Input } from 'react-native-system-ui'
...
`}},title:"清除按钮",identifier:"input-clearable",lang:"tsx",meta:{title:"清除按钮"}};function d(){const[t,u]=a.useState("");return e.jsx(l.Group,{children:e.jsx(n,{value:t,onChangeText:u,placeholder:"请输入短信验证码",prefix:"💁",suffix:e.jsx(C,{size:"small",type:"primary",onPress:()=>u(""),children:"发送"})})})}const F=`import React from 'react'
...
`}},title:"插入内容",identifier:"input-slots",lang:"tsx",meta:{title:"插入内容"}};function c(){return e.jsxs(l.Group,{children:[e.jsx(n.TextArea,{placeholder:"多行输入"}),e.jsx(n.TextArea,{placeholder:"自适应高度",autoSize:!0}),e.jsx(n.TextArea,{placeholder:"最小高度80，最大高度120",autoSize:{minHeight:80,maxHeight:120}})]})}const A=`import React from 'react'
import { Cell, Input } from 'react-native-system-ui'
...
`}},title:"多行输入",identifier:"input-textarea",lang:"tsx",meta:{title:"多行输入"}};function p(){return e.jsxs(l.Group,{children:[e.jsx(n,{placeholder:"最多输入10个字符",maxLength:10,onOverlimit:()=>g.info("不能超过10个字符哦🍺")}),e.jsx(n.TextArea,{placeholder:"字数统计",maxLength:50,showWordLimit:!0}),e.jsx(n.TextArea,{placeholder:"自定义输出",maxLength:80,showWordLimit:({currentCount:t,maxLength:u})=>`已经输入${t}/${u??"∞"}个字啦 ✍️`})]})}const B=`import React from 'react'
...
`}},title:"字数统计",identifier:"input-word-limit",lang:"tsx",meta:{title:"字数统计"}};function x(){const[t,u]=a.useState(""),[r,i]=a.useState("");return e.jsxs(l.Group,{children:[e.jsx(n,{placeholder:"内容居中",value:t,onChangeText:u,align:"center"}),e.jsx(n,{placeholder:"内容右对齐",value:r,onChangeText:i,align:"right"})]})}const R=`import React from 'react'
import { Cell, Input } from 'react-native-system-ui'
...
`}},title:"对齐方式",identifier:"input-align",lang:"tsx",meta:{title:"对齐方式"}};function h(){return e.jsxs(l.Group,{children:[e.jsx(n,{value:"只读模式",readOnly:!0}),e.jsx(n,{value:"禁用模式",disabled:!0})]})}const b=`import React from 'react'
import { Cell, Input } from 'react-native-system-ui'
...
`}},title:"输入框状态",identifier:"input-status",lang:"tsx",meta:{title:"输入框状态"}}],P={simulator:{compact:!0}},_=[{depth:1,text:"Input 输入框",id:"input-输入框"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"清除按钮",id:"清除按钮"},{depth:3,text:"插入内容",id:"插入内容"},{depth:3,text:"多行输入",id:"多行输入"},{depth:3,text:"字数统计",id:"字数统计"},{depth:3,text:"对齐方式",id:"对齐方式"},{depth:3,text:"输入框状态",id:"输入框状态"},{depth:2,text:"API",id:"api"},{depth:3,text:"Input Props",id:"input-props"},{depth:3,text:"Input.TextArea Props",id:"inputtextarea-props"},{depth:3,text:"Ref 方法",id:"ref-方法"}],M="/docs/components/input.md",N="Input 输入框",k="1770111044000",ye=t=>t.children({MdContent:L,demos:w,frontmatter:P,slugs:_,filePath:M,title:N,updatedTime:k});export{L as MdContent,ye as default,w as demos,M as filePath,P as frontmatter,_ as slugs,N as title,k as updatedTime};
