import{j as e,R as o}from"./main-CC2DK3OK.js";import{T as a}from"./Tag-BflPSI0C.js";import{S as i}from"./Space-DBTvvarp.js";import"./Close-BKbx2ovl.js";import"./IconBase-BNmvoXvm.js";import"./createComponentTokensHook-BcXZOvON.js";import"./hairline-Bq3nniT3.js";import"./index-CN-rk8sC.js";import"./extends-CF3RwP-h.js";import"./number-BG570ZaL.js";import"./useAriaPress-DVn62gIQ.js";import"./index-CJrLMJTa.js";function c(){return e.jsxs(i,{gap:12,wrap:!0,children:[e.jsx(a,{type:"primary",children:"主要"}),e.jsx(a,{type:"success",children:"成功"}),e.jsx(a,{type:"warning",children:"警告"}),e.jsx(a,{type:"danger",children:"危险"}),e.jsx(a,{children:"默认"})]})}const l=`import React from 'react'
...
`,p={code:l,sources:{_:{tsx:`import React from 'react'
...
`}},title:"基础用法",identifier:"tag-basic",lang:"tsx",meta:{title:"基础用法"}};function u(){const[t,n]=o.useState(!0);return e.jsxs(i,{gap:12,direction:"vertical",children:[e.jsxs(i,{gap:12,wrap:!0,children:[e.jsx(a,{plain:!0,type:"primary",children:"空心样式"}),e.jsx(a,{round:!0,type:"primary",children:"圆角样式"}),e.jsx(a,{mark:!0,type:"primary",children:"标记样式"})]}),t?e.jsx(a,{closeable:!0,plain:!0,type:"primary",onClose:()=>n(!1),children:"可关闭"}):null]})}const g=`import React from 'react'
...
`,m={code:g,sources:{_:{tsx:`import React from 'react'
...
`}},title:"样式风格",identifier:"tag-style",lang:"tsx",meta:{title:"样式风格"}};function s(){return e.jsxs(i,{gap:12,wrap:!0,children:[e.jsx(a,{size:"mini",type:"primary",children:"迷你"}),e.jsx(a,{type:"primary",children:"小型"}),e.jsx(a,{size:"medium",type:"primary",children:"中等"}),e.jsx(a,{size:"large",type:"primary",children:"大型"})]})}const x=`import React from 'react'
...
`,T={code:x,sources:{_:{tsx:`import React from 'react'
...
`}},title:"标签尺寸",identifier:"tag-size",lang:"tsx",meta:{title:"标签尺寸"}};function d(){return e.jsxs(i,{gap:12,wrap:!0,children:[e.jsx(a,{color:"#7c3aed",children:"定制背景"}),e.jsx(a,{color:"#ffe1e1",textColor:"#ad0000",children:"定制文字"}),e.jsx(a,{color:"#7c3aed",plain:!0,children:"空心配色"})]})}const h=`import React from 'react'
...
`,y={code:h,sources:{_:{tsx:`import React from 'react'
...
`}},title:"基础用法",identifier:"tag-basic",lang:"tsx",meta:{title:"基础用法"}},{Component:u,key:"tag-style",sources:{_:{tsx:`import React from 'react'
...
`}},title:"样式风格",identifier:"tag-style",lang:"tsx",meta:{title:"样式风格"}},{Component:s,key:"tag-size",sources:{_:{tsx:`import React from 'react'
...
`}},title:"自定义颜色",identifier:"tag-color",lang:"tsx",meta:{title:"自定义颜色"}}],S={simulator:{compact:!1}},E=[{depth:1,text:"Tag 标签",id:"tag-标签"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"样式风格",id:"样式风格"},{depth:3,text:"标签尺寸",id:"标签尺寸"},{depth:3,text:"自定义颜色",id:"自定义颜色"},{depth:2,text:"API",id:"api"},{depth:3,text:"Tag Props",id:"tag-props"}],F="/docs/components/tag.md",v="Tag 标签",C="1769570039000",V=t=>t.children({MdContent:j,demos:f,frontmatter:S,slugs:E,filePath:F,title:v,updatedTime:C});export{j as MdContent,V as default,f as demos,F as filePath,S as frontmatter,E as slugs,v as title,C as updatedTime};
