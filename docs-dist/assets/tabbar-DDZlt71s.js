import{R as p,r as u,j as e,V as b,s as Z,b as X,c as K,a as ve,S as fe}from"./main-BuQiU471.js";import{S as E,a as S}from"./SettingO-DWPCYo7L.js";import{S as R}from"./HomeO-B_AV1xpZ.js";import{S as _}from"./Search-BiBiRWIm.js";import{b as Te}from"./hairline-MnVzd1gq.js";import{c as Ie,T as je}from"./createComponentTokensHook-BZh_OSSd.js";import{u as ye}from"./useControllableValue-A2U09wcf.js";import{m as ge}from"./mergeTokensOverride-BizFhpDv.js";import{S as Fe}from"./SafeAreaView-B7j4syYp.js";import{B as Q}from"./Badge-DJK4MxrJ.js";import{M as Oe}from"./index-BRfylSA6.js";import{u as Ee}from"./useAriaPress-D5uAXibC.js";import{I as Se}from"./index-Ct6-Nt5P.js";import"./IconBase-CrFgzAiS.js";import"./useSafeAreaPadding-Dnz88xZy.js";import"./number-DwcHNqSr.js";import"./extends-CF3RwP-h.js";import"./index-CJrLMJTa.js";import"./index-BAZkLH96.js";const ee=p.createContext(null),Ce=()=>u.useContext(ee),we=r=>{const{palette:c,spacing:n,fontSize:o}=r;return{defaults:{fixed:!0,border:!0,placeholder:!1,safeAreaInsetBottom:!1},colors:{background:"#ffffff",border:c.default[200],active:c.primary[600],inactive:c.default[600]},layout:{height:50,paddingHorizontal:0,paddingVertical:n.xs},icon:{size:22},typography:{fontSize:o.sm,fontWeight:"400"}}},te=Ie("tabbar",we),Be=r=>{const{children:c,value:n,defaultValue:o,fixed:y,border:z,zIndex:k=1,activeColor:C,inactiveColor:x,background:I,placeholder:L,safeAreaInsetBottom:w,iconSize:W,tokensOverride:g,style:$,contentStyle:q,onChange:B,...m}=r,a=te(g),d=y??a.defaults.fixed,f=z??a.defaults.border,V=I??a.colors.background,P=L??a.defaults.placeholder,N=W??a.icon.size,G=w??d,v=u.useMemo(()=>p.Children.toArray(c).filter(p.isValidElement),[c]),F=v.length?v[0].props.name??0:void 0,[j,D]=ye(r,{defaultValue:F,valuePropName:"value",defaultValuePropName:"defaultValue",trigger:"onChange"}),J=v.map((i,h)=>i.props.name??h),s=j==null?F:J.some(i=>i===j)?j:F,[M,T]=u.useState(a.layout.height),l=d&&P,ue=u.useCallback(i=>{if(!l)return;const h=i.nativeEvent.layout.height;T(O=>Math.abs(O-h)<.5?O:h)},[l]),U=u.useCallback((i,h)=>D(i,h),[D]),be=u.useMemo(()=>({activeValue:s,activeColor:C??a.colors.active,inactiveColor:x??a.colors.inactive,fontSize:a.typography.fontSize,fontWeight:a.typography.fontWeight,onSelect:U}),[C,s,x,U,a.colors.active,a.colors.inactive,a.typography.fontSize,a.typography.fontWeight]),me=u.useMemo(()=>v.map((i,h)=>{const O=i.props.name??h;return p.cloneElement(i,{key:i.key??O,name:O,index:h,iconSize:N,tokensOverride:ge(g,i.props.tokensOverride)})}),[N,v,g]);if(v.length===0)return null;const de=G?Fe:b,le={height:M},he=[A.container,d&&[A.fixed,{zIndex:k}],$],pe=[A.bar,{backgroundColor:V,paddingHorizontal:a.layout.paddingHorizontal,minHeight:a.layout.height},f?Te(a.colors.border):null,q],xe=[A.row,{minHeight:a.layout.height}];return e.jsxs(e.Fragment,{children:[l&&e.jsx(b,{testID:"rv-tabbar-placeholder",style:le}),e.jsx(b,{...m,style:he,onLayout:ue,children:e.jsx(de,{style:pe,children:e.jsx(ee.Provider,{value:be,children:e.jsx(b,{style:xe,accessibilityRole:"tablist",children:me})})})})]})},A=Z.create({container:{width:"100%"},bar:{width:"100%"},row:{flexDirection:"row"},fixed:{position:"absolute",left:0,right:0,bottom:0}}),ae=p.memo(Be);ae.displayName="Tabbar";const Ve=r=>{const{name:c,icon:n,badge:o,dot:y=!1,onClick:z,textStyle:k,iconStyle:C,children:x,disabled:I=!1,style:L,index:w,testID:W,iconSize:g,tokensOverride:$,...q}=r,B=te($),m=Ce();if(!m)return null;const a=c??w??0,d=m.activeValue===a,f=d?m.activeColor:m.inactiveColor,V=g??B.icon.size,P=u.useCallback(s=>{if(!p.isValidElement(s))return s;const M=s,T={},l=M.props??{};return l.size==null&&(T.size=V),l.fill==null&&(T.fill=f),l.color==null&&(T.color=f),l.style!=null&&(T.style=[l.style,{color:f}]),p.cloneElement(M,T)},[f,V]),N=u.useCallback(()=>{if(!n)return null;const s=X(n)?n(d):n;return P(s)},[P,n,d]),G=u.useCallback(()=>X(x)?x(d):x,[x,d]),v=Ee({disabled:I,onPress:()=>{I||(z?.(),m.onSelect(a,w??0))},extraProps:{accessibilityRole:"tab",accessibilityState:{selected:d,disabled:I},testID:W??`rv-tabbar-item-${a}`}}),F=y||K(o),j=u.useCallback(()=>{if(K(o)){if(ve(o))return e.jsx(Q,{content:o});if(fe(o)){const s=o;return e.jsx(Q,{...s,dot:y||s.dot})}return o}return e.jsx(Q,{dot:!0})},[o,y]),D=[H.item,{height:B.layout.height,paddingVertical:B.layout.paddingVertical,opacity:I?.5:1},L],J=[H.label,{color:f,fontSize:m.fontSize,fontWeight:m.fontWeight,lineHeight:m.fontSize},k];return e.jsxs(Oe,{...q,...v.interactionProps,style:D,children:[e.jsxs(b,{style:[H.iconWrapper,C],children:[N(),F&&e.jsx(b,{style:H.badge,children:j()})]}),K(x)?e.jsx(je,{style:J,children:G()}):null]})},H=Z.create({item:{flex:1,alignItems:"center",justifyContent:"center",gap:4},iconWrapper:{alignItems:"center",justifyContent:"center"},badge:{position:"absolute",top:-4,right:-12},label:{includeFontPadding:!1}}),ne=p.memo(Ve);ne.displayName="Tabbar.Item";const t=ae;t.Item=ne;const re=()=>e.jsx(b,{children:e.jsxs(t,{fixed:!1,children:[e.jsx(t.Item,{icon:e.jsx(R,{}),children:"标签"}),e.jsx(t.Item,{icon:e.jsx(_,{}),children:"标签"}),e.jsx(t.Item,{icon:e.jsx(E,{}),children:"标签"}),e.jsx(t.Item,{icon:e.jsx(S,{}),children:"标签"})]})}),Pe=`import React from 'react'
...
`}},title:"基础用法",identifier:"tabbar-base",lang:"tsx",meta:{title:"基础用法"}},ie=()=>{const[r,c]=p.useState("setting");return e.jsx(b,{children:e.jsxs(t,{fixed:!1,value:r,onChange:n=>c(n),children:[e.jsx(t.Item,{name:"home",icon:e.jsx(R,{}),children:"标签"}),e.jsx(t.Item,{name:"search",icon:e.jsx(_,{}),children:"标签"}),e.jsx(t.Item,{name:"firends",icon:e.jsx(E,{}),children:"标签"}),e.jsx(t.Item,{name:"setting",icon:e.jsx(S,{}),children:"标签"})]})})},De=`import React from 'react'
import { View } from 'react-native'
...
`}},title:"受控组件",identifier:"tabbar-control",lang:"tsx",meta:{title:"受控组件"}},ce=()=>e.jsx(b,{children:e.jsxs(t,{fixed:!1,children:[e.jsx(t.Item,{icon:e.jsx(R,{}),children:"标签"}),e.jsx(t.Item,{badge:{dot:!0},icon:e.jsx(_,{}),children:"标签"}),e.jsx(t.Item,{badge:{content:5},icon:e.jsx(E,{}),children:"标签"}),e.jsx(t.Item,{badge:{content:20},icon:e.jsx(S,{}),children:"标签"})]})}),Ae=`import React from 'react'
import { View } from 'react-native'
...
`}},title:"自定义图标",identifier:"tabbar-custom-icon",lang:"tsx",meta:{title:"自定义图标"}},se=()=>e.jsx(b,{children:e.jsxs(t,{fixed:!1,activeColor:"#f44336",inactiveColor:"#000",children:[e.jsx(t.Item,{icon:e.jsx(R,{}),children:"颜色"}),e.jsx(t.Item,{icon:e.jsx(_,{}),children:"颜色"}),e.jsx(t.Item,{icon:e.jsx(E,{}),children:"颜色"}),e.jsx(t.Item,{icon:e.jsx(S,{}),children:"颜色"})]})}),ze=`import React from 'react'
import { View } from 'react-native'
