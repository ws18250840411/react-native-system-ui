import{R as p,j as e}from"./main-CC2DK3OK.js";import{C as E}from"./Calendar-CaHAGnBI.js";import{C as h}from"./index-Dueh9AzQ.js";import{T as A}from"./index-CYc3exVx.js";import"./Popup-G3cXoDWN.js";import"./createPlatformShadow-BbOkyb5V.js";import"./IconBase-BNmvoXvm.js";import"./Portal-D9I31KH1.js";import"./createComponentTokensHook-BcXZOvON.js";import"./Animated-C-b5K9fC.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./index-Cakcz3d2.js";import"./index-CCOraIhd.js";import"./index-D_JlQYPg.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-xa377Hoz.js";import"./useAriaPress-DVn62gIQ.js";import"./index-BP7Blb5n.js";import"./index-CN-rk8sC.js";import"./SafeAreaView-CgItGtgs.js";import"./useSafeAreaPadding-B0opQgwg.js";import"./useControllableValue-BBYtc-A6.js";import"./Arrow-CP2eQgBg.js";import"./hairline-Bq3nniT3.js";import"./Loading-_9EKEhr2.js";import"./index-BnjI8SiS.js";import"./Checked-BJm2Hkef.js";import"./Close-BKbx2ovl.js";const m=n=>n&&(Array.isArray(n)?n.map(l=>new Date(l)):new Date(n)),O=(n,l)=>n?l==="single"?n instanceof Date?n.toLocaleDateString():"请选择日期":l==="multiple"?Array.isArray(n)&&n.length?`共${n.length}个日期`:"请选择日期":Array.isArray(n)&&n.length===2?`${n[0].toLocaleDateString()} ~ ${n[1].toLocaleDateString()}`:"请选择日期":"请选择日期",r=n=>{const{key:l,title:t,type:a="single",showConfirm:i,cellProps:u,initialValue:y,valueFormatter:o,onChange:s,...j}=n,[D,k]=p.useState(!1),[C,V]=p.useState(()=>m(y??null)),[L,f]=p.useState(null),g=i??a!=="single",v=p.useCallback(d=>{f(d?m(C):null),k(d)},[C]),S=p.useCallback(d=>{const c=m(d);f(c),g||(V(c),s?.(c,a))},[g,s,a]),F=p.useCallback(d=>{const c=m(d);V(c),s?.(c,a)},[s,a]),w=o?o(C,a):O(C,a),P=L??C;return{cell:e.jsx(h,{title:t,value:w,isLink:!0,onPress:()=>v(!0),...u},`cell-${l}`),calendar:e.jsx(E,{...j,poppable:!0,type:a,visible:D,value:P??null,showConfirm:g,onVisibleChange:v,onSelect:S,onConfirm:F},`calendar-${l}`)}};function x(){const n=r({key:"basic-single",title:"单个日期",showConfirm:!1}),l=r({key:"basic-multiple",title:"多个日期",type:"multiple"}),t=r({key:"basic-range",title:"日期区间",type:"range",cellProps:{titleStyle:{width:96}}}),a=[n,l,t];return e.jsxs(e.Fragment,{children:[e.jsx(h.Group,{title:"基础",card:!0,children:a.map(i=>i.cell)}),a.map(i=>i.calendar)]})}const M=`import React from 'react'
...
`}},title:"基础用法",identifier:"calendar-basic",lang:"tsx",meta:{title:"基础用法"}};function b(){const n=r({key:"range-default",title:"日期区间",type:"range"}),l=r({key:"range-quick",title:"快速选择",type:"range",showConfirm:!1,allowSameDay:!0}),t=r({key:"range-limit",title:"限制 3 天",type:"range",maxRange:3,onOverRange:u=>A.info(`最多选择${u}天`)}),a=r({key:"range-theme",title:"主题颜色",type:"range",color:"#ee0a24"}),i=[n,l,t,a];return e.jsxs(e.Fragment,{children:[e.jsx(h.Group,{title:"范围",card:!0,children:i.map(u=>u.cell)}),i.map(u=>u.calendar)]})}const $=`import React from 'react'
...
`}},title:"范围选择",identifier:"calendar-range",lang:"tsx",meta:{title:"范围选择"}};function R(){const n=r({key:"single",title:"单个日期",showConfirm:!1}),l=r({key:"multiple",title:"多个日期",type:"multiple"}),t=r({key:"range",title:"日期区间",type:"range"}),a=r({key:"quick-single",title:"即时选择",showConfirm:!1}),i=r({key:"quick-range",title:"即时区间",type:"range",showConfirm:!1,allowSameDay:!0}),u=r({key:"theme",title:"自定义主题",type:"range",color:"#ee0a24",popupProps:{overlayStyle:{backgroundColor:"rgba(0,0,0,0.4)"},style:{paddingHorizontal:16,paddingTop:24,paddingBottom:32}},weekdays:["🌕","🌖","🌗","🌘","🌑","🌒","🌓"],formatMonthTitle:o=>`${o.getFullYear()} · ${o.getMonth()+1}`,cellProps:{valueStyle:{color:"#ee0a24",fontWeight:"600"}}}),y=[{title:"基础弹层",entries:[n,l,t]},{title:"快捷选择",entries:[a,i]},{title:"自定义样式",entries:[u]}];return e.jsxs(e.Fragment,{children:[y.map(o=>e.jsx(h.Group,{title:o.title,card:!0,children:o.entries.map(s=>s.cell)},o.title)),[n,l,t,a,i,u].map(o=>o.calendar)]})}const B=`import React from 'react'
import { Cell } from 'react-native-system-ui'
...
`}},title:"弹层模式",identifier:"calendar-popup",lang:"tsx",meta:{title:"弹层模式"}}],_={simulator:{compact:!0}},I=[{depth:1,text:"Calendar 日历",id:"calendar-日历"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"范围选择",id:"范围选择"},{depth:3,text:"弹层模式",id:"弹层模式"},{depth:2,text:"API",id:"api"}],H="/docs/components/calendar.md",U="Calendar 日历",W="1770373480000",Re=n=>n.children({MdContent:G,demos:T,frontmatter:_,slugs:I,filePath:H,title:U,updatedTime:W});export{G as MdContent,Re as default,T as demos,H as filePath,_ as frontmatter,I as slugs,U as title,W as updatedTime};
