...
`}},title:"描述与副标题",identifier:"action-sheet-description",lang:"tsx",meta:{title:"描述与副标题"}},Re=[{name:"选项一",color:"#ee0a24"},{name:"选项二",disabled:!0},{loading:!0}],U=()=>{const[n,t]=h.useState(!1),i=()=>t(!1);return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"选项状态",isLink:!0,onPress:()=>t(!0)}),e.jsx(C,{visible:n,onCancel:i,actions:Re,cancelText:"取消",closeOnClickAction:!0,onSelect:s=>{s.name&&P.info(String(s.name))}})]})},De=`import React from 'react'
import { ActionSheet, Cell, Toast } from 'react-native-system-ui'
...
`,Le={code:De,sources:{_:{tsx:`import React from 'react'
import { ActionSheet, Cell, Toast } from 'react-native-system-ui'
...
`}},title:"选项状态",identifier:"action-sheet-status",lang:"tsx",meta:{title:"选项状态"}},X=()=>{const[n,t]=h.useState(!1),i=()=>t(!1);return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"自定义面板",isLink:!0,onPress:()=>t(!0)}),e.jsx(C,{visible:n,onCancel:i,children:e.jsx(u,{style:Ne.content,children:e.jsx(S,{children:"内容"})})})]})},Ne=je.create({content:{padding:16,paddingBottom:160}}),Oe=`import React from 'react'
...
`,Me={code:Oe,sources:{_:{tsx:`import React from 'react'
import { View, Text, StyleSheet } from 'react-native'
import { ActionSheet, Cell } from 'react-native-system-ui'
...
`}},title:"自定义内容",identifier:"action-sheet-custom",lang:"tsx",meta:{title:"自定义内容"}}],Ie={simulator:{compact:!0}},ze=[{depth:1,text:"ActionSheet 动作面板",id:"actionsheet-动作面板"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"描述与副标题",id:"描述与副标题"},{depth:3,text:"选项状态",id:"选项状态"},{depth:3,text:"自定义内容",id:"自定义内容"},{depth:2,text:"API",id:"api"},{depth:3,text:"ActionSheet Props",id:"actionsheet-props"},{depth:3,text:"ActionSheetAction",id:"actionsheetaction"}],He="/docs/components/action-sheet.md",$e="ActionSheet 动作面板",Ge="1768553221000",ft=n=>n.children({MdContent:we,demos:_e,frontmatter:Ie,slugs:ze,filePath:He,title:$e,updatedTime:Ge});export{we as MdContent,ft as default,_e as demos,He as filePath,Ie as frontmatter,ze as slugs,$e as title,Ge as updatedTime};
