import{R as r,j as e}from"./main-CC2DK3OK.js";import{F as a}from"./Field-DkY6Dtkh.js";import{T as o}from"./createComponentTokensHook-BcXZOvON.js";import{S as B}from"./ArrowDown-DW-SKLkl.js";import{B as x}from"./index-BfHwmVBQ.js";import{M as E}from"./index-CN-rk8sC.js";import{P as D}from"./Popup-G3cXoDWN.js";import{P as R}from"./Picker-BzpxbIBG.js";import{a as h}from"./index-Dueh9AzQ.js";import"./IconBase-BNmvoXvm.js";import"./index-D03jSN7d.js";import"./useLocale-B4lUqsPR.js";import"./hairline-Bq3nniT3.js";import"./promise-DzoogS-n.js";import"./Close-BKbx2ovl.js";import"./Animated-C-b5K9fC.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./index-Cakcz3d2.js";import"./index-CCOraIhd.js";import"./index-D_JlQYPg.js";import"./index-BnjI8SiS.js";import"./animation-BpxpeSKC.js";import"./Portal-D9I31KH1.js";import"./index-CfGUJPQW.js";import"./createPlatformShadow-BbOkyb5V.js";import"./color-BplLcdBL.js";import"./number-BG570ZaL.js";import"./useAriaPress-DVn62gIQ.js";import"./useOverlayStack-xa377Hoz.js";import"./index-BP7Blb5n.js";import"./SafeAreaView-CgItGtgs.js";import"./useSafeAreaPadding-B0opQgwg.js";import"./Loading-_9EKEhr2.js";import"./compare-B0QhPEQa.js";import"./Arrow-CP2eQgBg.js";function m(){const[t,l]=r.useState("");return e.jsx(a,{label:"文本",tooltip:"说明文字",placeholder:"请输入文本",description:"We must make sure that you are a human.",value:t,onChangeText:l})}const P=`import React from 'react'
...
`}},title:"基础用法",identifier:"field-basic",lang:"tsx",meta:{title:"基础用法"}};function p(){const[t,l]=r.useState(""),[n,i]=r.useState("");return e.jsxs(e.Fragment,{children:[e.jsx(a,{label:"文本",leftIcon:e.jsx(o,{children:"📦"}),tooltip:"提示",placeholder:"请输入内容",center:!0,value:n,onChangeText:i}),e.jsx(a,{label:"文本",leftIcon:e.jsx(o,{children:"📱"}),placeholder:"请输入手机号",center:!0,clearable:!0,value:t,onChangeText:l})]})}const S=`import React from 'react'
...
`,N={code:S,sources:{_:{tsx:`import React from 'react'
import { Text } from 'react-native'
...
`}},title:"图标与清除",identifier:"field-icon",lang:"tsx",meta:{title:"图标与清除"}};function f(){const[t,l]=r.useState(""),[n,i]=r.useState("");return e.jsxs(e.Fragment,{children:[e.jsx(a,{required:!0,label:"用户名",placeholder:"请输入用户名",value:t,onChangeText:l,error:!0}),e.jsx(a,{required:!0,label:"手机号",placeholder:"请输入手机号",value:n,onChangeText:i,keyboardType:"number-pad",errorMessage:"手机号格式错误"})]})}const I=`import React from 'react'
import { Field } from 'react-native-system-ui'
...
`,V={code:I,sources:{_:{tsx:`import React from 'react'
import { Field } from 'react-native-system-ui'
...
`}},title:"错误提示",identifier:"field-error",lang:"tsx",meta:{title:"错误提示"}};function j(){const[t,l]=r.useState(""),[n,i]=r.useState(!1),[s,g]=r.useState(["86"]),[c,u]=r.useState(["86"]),y=[[{label:"86 🇨🇳",value:"86"},{label:"87 🇺🇸",value:"87"},{label:"88 🏳️‍🌈",value:"88"},{label:"89 🏳️‍⚧️",value:"89"},{label:"90 🇵🇪",value:"90"},{label:"91 🇩🇪",value:"91"},{label:"92 🇯🇵",value:"92"}]];return e.jsxs(e.Fragment,{children:[e.jsx(a,{center:!0,controlAlign:"center",label:"短信验证码",prefix:e.jsxs(E,{style:{flexDirection:"row",alignItems:"center"},onPress:()=>{u(s),i(!0)},children:[e.jsxs(o,{children:["+",s[0]]}),e.jsx(B,{size:16,fill:"#969799",color:"#969799",style:{marginLeft:8}})]}),suffix:e.jsx(x,{size:"small",type:"primary",children:"发送"}),placeholder:"手机号",value:t,onChangeText:l,onClickInput:()=>{u(s),i(!0)}}),e.jsx(D,{visible:n,round:!0,position:"bottom",onClose:()=>i(!1),children:e.jsx(R,{title:"选择区号",columns:y,value:c,onChange:A=>u(A),onConfirm:()=>{g(c),i(!1)},onCancel:()=>i(!1)})})]})}const _=`import React from 'react'
...
`}},title:"插入按钮",identifier:"field-custom",lang:"tsx",meta:{title:"插入按钮"}},d=t=>t.replace(/\s/g,"").replace(/\D/g,"").slice(0,19).replace(/(\d{4})(?=\d)/g,"$1 ");function F(){const[t,l]=r.useState(""),[n,i]=r.useState("");return e.jsxs(h,{children:[e.jsx(a,{label:"银行卡",placeholder:"输入时自动格式化",value:t,onChangeText:l,formatter:d,maxLength:23}),e.jsx(a,{label:"银行卡",placeholder:"失焦时自动格式化",value:n,onChangeText:i,formatter:d,formatTrigger:"onBlur",maxLength:23})]})}const w=`import React from 'react'
...
`}},title:"格式化输入内容",identifier:"field-formatter",lang:"tsx",meta:{title:"格式化输入内容"}};function v(){const[t,l]=r.useState("");return e.jsx(a,{label:"留言",type:"textarea",rows:1,autoSize:!0,placeholder:"请输入留言",value:t,onChangeText:l})}const L=`import React from 'react'
import { Field } from 'react-native-system-ui'
...
`}},title:"高度自适应",identifier:"field-textarea",lang:"tsx",meta:{title:"高度自适应"}};function b(){return e.jsx(h,{children:e.jsx(a,{label:"文本",placeholder:"输入框内容右对齐",inputAlign:"right",center:!0})})}const z=`import React from 'react'
import { Field, FieldGroup } from 'react-native-system-ui'
...
`}},title:"输入框内容对齐",identifier:"field-align",lang:"tsx",meta:{title:"输入框内容对齐"}};function C(){const t=r.useRef(null);return e.jsx(a,{center:!0,ref:t,label:"文本",placeholder:"请输入文本",suffix:e.jsx(x,{size:"small",onPress:()=>t.current?.focus(),children:"聚焦"})})}const q=`import React from 'react'
