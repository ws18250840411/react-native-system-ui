import{j as e,V as c,R as F}from"./main-CC2DK3OK.js";import{F as r}from"./index-CrmypR8q.js";import{F as a}from"./Field-DkY6Dtkh.js";import{B as m}from"./index-BfHwmVBQ.js";import{T as d}from"./index-CYc3exVx.js";import{C as p}from"./index-Dueh9AzQ.js";import{S as N}from"./Switch-BkhMHGaV.js";import{S as z}from"./Stepper-BdMDYGHE.js";import{S as A}from"./Slider-DVgyzboI.js";import{R as b}from"./index-BDEHY1tF.js";import{C as f}from"./index-Co4y2txS.js";import{S as C}from"./Space-DBTvvarp.js";import{S as O}from"./AddO-7QWEZ0Nb.js";import{T as M}from"./createComponentTokensHook-BcXZOvON.js";import{P as j}from"./Popup-G3cXoDWN.js";import{P as R}from"./Picker-BzpxbIBG.js";import{D as H}from"./DatetimePicker-BulZtZtf.js";import{C as _}from"./Calendar-CaHAGnBI.js";import{S as L}from"./Selector-DJUHCFBM.js";import"./promise-DzoogS-n.js";import"./compare-B0QhPEQa.js";import"./IconBase-BNmvoXvm.js";import"./index-D03jSN7d.js";import"./useLocale-B4lUqsPR.js";import"./hairline-Bq3nniT3.js";import"./Close-BKbx2ovl.js";import"./Animated-C-b5K9fC.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./index-Cakcz3d2.js";import"./index-CCOraIhd.js";import"./index-D_JlQYPg.js";import"./index-CN-rk8sC.js";import"./index-BnjI8SiS.js";import"./animation-BpxpeSKC.js";import"./Portal-D9I31KH1.js";import"./index-CfGUJPQW.js";import"./createPlatformShadow-BbOkyb5V.js";import"./color-BplLcdBL.js";import"./number-BG570ZaL.js";import"./useAriaPress-DVn62gIQ.js";import"./Loading-_9EKEhr2.js";import"./Checked-BJm2Hkef.js";import"./index-BP7Blb5n.js";import"./SafeAreaView-CgItGtgs.js";import"./useSafeAreaPadding-B0opQgwg.js";import"./useOverlayStack-xa377Hoz.js";import"./Arrow-CP2eQgBg.js";import"./useControllableValue-BBYtc-A6.js";import"./useLabel-FqIItfPo.js";import"./useFormValidationState-bq-UKE7g.js";import"./date-DjZXGQxL.js";function V(){const n=r.useForm();return e.jsxs(r,{ref:n,onFinish:l=>d.info(JSON.stringify(l)),style:{paddingHorizontal:12},footer:e.jsx(m,{round:!0,block:!0,type:"primary",text:"提交",onPress:()=>n.current?.submit(),style:{marginTop:12}}),children:[e.jsx(r.Item,{name:"username",label:"用户名",rules:[{required:!0,message:"请填写用户名"}],children:e.jsx(a,{placeholder:"请输入用户名",clearable:!0})}),e.jsx(r.Item,{name:"password",label:"密码",rules:[{required:!0,message:"请填写密码"}],children:e.jsx(a,{placeholder:"请输入密码",type:"password",border:!1})})]})}const J=`import React from 'react'
...
`}},title:"基础用法",identifier:"form-basic",lang:"tsx",meta:{title:"基础用法"}};function I(){const n=r.useForm(),l=async t=>(d.info({message:"验证中...",duration:800}),await new Promise(o=>setTimeout(o,800)),/^\d{6}$/.test(t??"")?!0:"请输入正确内容");return e.jsxs(r,{ref:n,onFinish:t=>d.info(JSON.stringify(t)),style:{paddingHorizontal:12},footer:e.jsx(m,{round:!0,block:!0,type:"primary",text:"提交",onPress:()=>n.current?.submit(),style:{marginTop:12}}),children:[e.jsx(r.Item,{name:"pattern",label:"正则校验",rules:[{pattern:/^\d{6}$/,message:"请输入 6 位数字"}],children:e.jsx(a,{placeholder:"请输入 6 位数字",clearable:!0})}),e.jsx(r.Item,{name:"validator",label:"函数校验",rules:[{validator:t=>/^1\d{10}$/.test(t??"")?!0:"请输入正确的手机号码"}],children:e.jsx(a,{placeholder:"请输入手机号",clearable:!0})}),e.jsx(r.Item,{name:"async",label:"异步校验",validateTrigger:"onBlur",rules:[{validateTrigger:"onBlur",validator:l}],children:e.jsx(a,{placeholder:"请输入 6 位数字",border:!1})})]})}const $=`import React from 'react'
...
`}},title:"表单项类型",identifier:"form-type",lang:"tsx",meta:{title:"表单项类型"}};function P(){const n=r.useForm();return e.jsx(r,{ref:n,initialValues:{users:[{name:"",age:""}]},onFinish:l=>d.info(JSON.stringify(l)),style:{paddingHorizontal:12},footer:e.jsx(m,{round:!0,block:!0,type:"primary",text:"提交",onPress:()=>n.current?.submit(),style:{marginTop:12}}),children:e.jsx(r.List,{name:"users",children:(l,{add:t,remove:o})=>e.jsxs(e.Fragment,{children:[l.map((i,s)=>e.jsxs(c,{style:{marginBottom:24},children:[e.jsxs(M,{style:{fontSize:14,color:"#969799",paddingVertical:12,lineHeight:16},children:["用户 ",s+1]}),e.jsx(r.Item,{name:[i.name,"name"],children:e.jsx(a,{label:"姓名",placeholder:"请输入姓名",clearable:!0})}),e.jsx(r.Item,{name:[i.name,"age"],children:e.jsx(a,{label:"年龄",placeholder:"请输入年龄",clearable:!0})}),e.jsx(m,{size:"small",type:"danger",text:"删除",onPress:()=>o(s),style:{marginTop:8}})]},i.key)),e.jsx(m,{plain:!0,block:!0,icon:e.jsx(O,{size:16}),text:"新增用户",onPress:()=>t({name:"",age:""})})]})})})}const K=`import React from 'react'
import { View, Text } from 'react-native'
...
`}},title:"动态增减表单项",identifier:"form-list",lang:"tsx",meta:{title:"动态增减表单项"}},X=[{label:"南京",value:"南京"},{label:"苏州",value:"苏州"},{label:"常州",value:"常州"},{label:"淮安",value:"淮安"},{label:"扬州",value:"扬州"},{label:"南通",value:"南通"},{label:"宿迁",value:"宿迁"},{label:"泰州",value:"泰州"},{label:"无锡",value:"无锡"}],Y=({formRef:n})=>{const[l,t]=F.useState(!1),[o,i]=F.useState(!1),[s,x]=F.useState(!1),h=r.useWatch("city",n),v=r.useWatch("date",n),y=r.useWatch("calendar",n),g=u=>u?new Date(u).toLocaleDateString():"";return e.jsxs(e.Fragment,{children:[e.jsx(r.Item,{name:"city",label:"城市",children:e.jsx(a,{readOnly:!0,clickable:!0,isLink:!0,value:h?String(h):"",placeholder:"请选择城市",onClick:()=>t(!0)})}),e.jsx(r.Item,{name:"date",label:"日期",children:e.jsx(a,{readOnly:!0,clickable:!0,isLink:!0,value:g(v),placeholder:"请选择日期",onClick:()=>i(!0)})}),e.jsx(r.Item,{name:"calendar",label:"日历",children:e.jsx(a,{readOnly:!0,clickable:!0,isLink:!0,value:g(y),placeholder:"请选择日期",onClick:()=>x(!0),border:!1})}),e.jsx(j,{visible:l,placement:"bottom",round:!0,onClose:()=>t(!1),children:e.jsx(R,{title:"城市选择",columns:X,value:h,onConfirm:u=>{n.current?.setFieldsValue({city:u[0]}),t(!1)},onCancel:()=>t(!1)})}),e.jsx(H,{popup:!0,popupVisible:o,onPopupVisibleChange:i,type:"date",value:v??new Date,onConfirm:u=>n.current?.setFieldsValue({date:u}),onCancel:()=>i(!1),showToolbar:!0}),e.jsx(_,{poppable:!0,visible:s,onVisibleChange:x,value:y,onConfirm:u=>{const w=Array.isArray(u)?u[0]:u;n.current?.setFieldsValue({calendar:w})}})]})};function B(){const n=r.useForm();return e.jsx(r,{ref:n,onFinish:l=>d.info(JSON.stringify(l)),style:{paddingHorizontal:12},footer:e.jsx(m,{round:!0,block:!0,type:"primary",text:"提交",onPress:()=>n.current?.submit(),style:{marginTop:12}}),children:e.jsx(Y,{formRef:n})})}const Z=`import React from 'react'
...
`}},title:"弹层选择",identifier:"form-popup",lang:"tsx",meta:{title:"弹层选择"}},re=[{label:"+86",value:"86"},{label:"+1",value:"1"},{label:"+81",value:"81"}],ne=({value:n={prefix:"86",value:""},onChange:l})=>{const[t,o]=F.useState(!1),i=s=>{l?.({...n,...s})};return e.jsxs(e.Fragment,{children:[e.jsxs(c,{style:{flexDirection:"row",alignItems:"center"},children:[e.jsx(c,{style:{width:100,marginRight:12},children:e.jsx(a,{readOnly:!0,clickable:!0,isLink:!0,value:`+${n.prefix}`,onClick:()=>o(!0)})}),e.jsx(c,{style:{flex:1},children:e.jsx(a,{value:n.value,placeholder:"请输入手机号",onChangeText:s=>i({value:s})})})]}),e.jsx(j,{visible:t,placement:"bottom",round:!0,onClose:()=>o(!1),children:e.jsx(R,{title:"选择区号",columns:re,value:n.prefix,onConfirm:s=>{i({prefix:String(s[0]??n.prefix)}),o(!1)},onCancel:()=>o(!1)})})]})};function D(){const n=r.useForm(),l=t=>t?.prefix&&t?.value?!0:"请输入区号和手机号";return e.jsxs(r,{ref:n,onFinish:t=>d.info(JSON.stringify(t)),style:{paddingHorizontal:12},footer:e.jsx(m,{round:!0,block:!0,type:"primary",text:"提交",onPress:()=>n.current?.submit(),style:{marginTop:12}}),children:[e.jsx(r.Item,{name:"name",label:"姓名",children:e.jsx(a,{placeholder:"请输入姓名"})}),e.jsx(r.Item,{name:"mobile",label:"手机号",initialValue:{prefix:"86",value:""},rules:[{validator:l}],trigger:"onChange",valuePropName:"value",children:e.jsx(ne,{})})]})}const te=`import React from 'react'
...
`,le={code:te,sources:{_:{tsx:`import React from 'react'
import { View } from 'react-native'
...
`}},title:"自定义表单项",identifier:"form-custom",lang:"tsx",meta:{title:"自定义表单项"}},ae=[{label:"手机号",value:"mobile"},{label:"住址",value:"address"}];function S(){const n=r.useForm();return e.jsxs(r,{ref:n,initialValues:{type:["mobile"]},onFinish:l=>d.info(JSON.stringify(l)),style:{paddingHorizontal:12},footer:e.jsx(m,{round:!0,block:!0,type:"primary",text:"提交",onPress:()=>n.current?.submit(),style:{marginTop:12}}),children:[e.jsx(r.Item,{name:"type",label:"联系方式",trigger:"onChange",children:e.jsx(L,{multiple:!0,options:ae})}),e.jsx(r.Item,{shouldUpdate:(l,t)=>l.type!==t.type,children:({getFieldValue:l})=>{const t=l("type")??[];return e.jsxs(e.Fragment,{children:[t.includes("mobile")?e.jsx(r.Item,{name:"mobile",label:"手机号",children:e.jsx(a,{placeholder:"请输入手机号",clearable:!0})}):null,t.includes("address")?e.jsxs(e.Fragment,{children:[e.jsx(r.Item,{name:"area",label:"地区",children:e.jsx(a,{placeholder:"请输入地区",clearable:!0})}),e.jsx(r.Item,{name:"address",label:"详细地址",children:e.jsx(a,{placeholder:"请输入详细地址",border:!1})})]}):null]})}})]})}const oe=`import React from 'react'
...
`}},title:"条件渲染/shouldUpdate",identifier:"form-shouldupdate",lang:"tsx",meta:{title:"条件渲染/shouldUpdate"}},se=n=>Object.entries(n).map(([l,t])=>`${l}: ${t??""}`).join("，");function T(){const n=r.useForm();return e.jsxs(r,{ref:n,initialValues:{a:"",b:""},style:{paddingHorizontal:12},children:[e.jsx(r.Item,{name:"a",label:"字段 A",children:e.jsx(a,{placeholder:"请输入内容",clearable:!0})}),e.jsx(r.Item,{name:"b",label:"字段 B",children:e.jsx(a,{placeholder:"请输入内容",clearable:!0})}),e.jsx(r.Subscribe,{to:["a","b"],children:(l,t)=>e.jsx(a,{readOnly:!0,label:"最近变更",value:Object.keys(l).length?se(l):"",placeholder:"输入字段 A / 字段 B 触发",border:!1})})]})}const ue=`import React from 'react'
...
`}},title:"订阅",identifier:"form-subscribe",lang:"tsx",meta:{title:"订阅"}},de=({formRef:n})=>{const l=r.useWatch("username",n),t=r.useWatch(void 0,n);return e.jsxs(e.Fragment,{children:[e.jsx(a,{readOnly:!0,label:"实时用户名",value:l?String(l):""}),e.jsx(a,{readOnly:!0,label:"所有值",value:t?JSON.stringify(t):"",border:!1})]})};function E(){const n=r.useForm();return e.jsxs(r,{ref:n,initialValues:{username:"Jack",phone:""},style:{paddingHorizontal:12},children:[e.jsx(r.Item,{name:"username",label:"用户名",children:e.jsx(a,{placeholder:"请输入用户名",clearable:!0})}),e.jsx(r.Item,{name:"phone",label:"手机号",children:e.jsx(a,{placeholder:"请输入手机号",clearable:!0})}),e.jsx(de,{formRef:n})]})}const ce=`import React from 'react'
import { Field, Form } from 'react-native-system-ui'
