import{R as p,r as d,j as e,V as b,s as R}from"./main-BuQiU471.js";import{T as w}from"./createComponentTokensHook-BZh_OSSd.js";import{P as N}from"./Picker-BONZaxGh.js";import{F as z}from"./Field-u5r-1eRM.js";import{B as M}from"./index-CvolElyI.js";import"./Loading-0Dos1lSL.js";import"./index-CA-bMxjH.js";import"./extends-CF3RwP-h.js";import"./color-DLepBbWK.js";import"./number-DwcHNqSr.js";import"./index-CJrLMJTa.js";import"./index-BRfylSA6.js";import"./compare-B0QhPEQa.js";import"./index-CfLKkUWT.js";import"./index-BAZkLH96.js";import"./IconBase-CrFgzAiS.js";import"./index-CvjfcfGO.js";import"./Arrow-xfLuWLNA.js";import"./hairline-MnVzd1gq.js";import"./useAriaPress-D5uAXibC.js";import"./index-C8B1H8uh.js";import"./useLocale-37vdikYq.js";import"./promise-CJeOJGOl.js";import"./Close-6I0X32OQ.js";import"./Popup-Bft8PaUM.js";import"./createPlatformShadow-BbOkyb5V.js";import"./Portal-Bl5GJ6OP.js";import"./Overlay-BCBJ7Bg0.js";import"./Animated-CaOvDCxr.js";import"./index-Ct6-Nt5P.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-B_-drOoO.js";import"./index-COVjMqe7.js";import"./SafeAreaView-B7j4syYp.js";import"./useSafeAreaPadding-Dnz88xZy.js";import"./index-CG41vsan.js";const B=t=>t?Object.entries(t).sort(([n],[i])=>n.localeCompare(i)):[],A=t=>t.slice(0,2),V=t=>t.slice(0,4),D=(t,n)=>{const i=new Map;return B(t).forEach(([o,a])=>{const s=n(o),r=i.get(s);r?r.push({label:a,value:o}):i.set(s,[{label:a,value:o}])}),i},O=(t,n=3)=>{const i=B(t.province_list);if(n===1)return i.map(([a,s])=>({label:s,value:a}));const o=D(t.city_list,A);if(n===3){const a=D(t.county_list,V);o.forEach(s=>{s.forEach(r=>{const c=V(r.value),l=a.get(c);l&&l.length&&(r.children=l)})})}return i.map(([a,s])=>{const r={label:s,value:a},c=A(a),l=o.get(c);return l&&l.length&&(r.children=l),r})},k=(t,n,i)=>{if(!n)return n;const o=Array.isArray(n)?n.map(String):[String(n)],a=[];let s=t;for(let r=0;r<i&&s?.length;r+=1){const c=o[r],l=s.find(u=>String(u.value)===c)??s[0];if(!l)break;a.push(String(l.value)),s=l.children}return a},I=t=>{const{areaList:n,columnsNum:i=3,value:o,defaultValue:a,onChange:s,onConfirm:r,interactionMode:c="sync",...l}=t,u=d.useMemo(()=>i>=1&&i<=3?i:3,[i]),{province_list:g,city_list:C,county_list:T}=n,y=d.useMemo(()=>O({province_list:g,city_list:C,county_list:T},u),[C,T,g,u]),x=d.useCallback(h=>h===void 0?void 0:k(y,h,u),[y,u]),E=d.useMemo(()=>x(o),[x,o]),F=d.useMemo(()=>x(a),[x,a]),S=d.useCallback(h=>h?(P,_)=>h(P.map(String),_):void 0,[]);return e.jsx(N,{...l,columns:y,interactionMode:c,value:E,defaultValue:F,onChange:S(s),onConfirm:S(r)})},v=p.memo(I);v.displayName="Area";const m={province_list:{11e4:"北京",31e4:"上海"},city_list:{110100:"北京市",310100:"上海市"},county_list:{110101:"东城区",110102:"西城区",310101:"黄浦区"}};function H(){const[t,n]=p.useState(["110000","110100","110101"]);return e.jsx(v,{areaList:m,value:t,onChange:n,title:"选择地区"})}function W(){const[t,n]=p.useState(["110000","110100"]);return e.jsx(v,{areaList:m,columnsNum:2,value:t,onChange:n,title:"省市选择"})}function G(){const[t,n]=p.useState(["110000","110100","110101"]),i=[m.province_list[t[0]],m.city_list[t[1]],m.county_list[t[2]]].filter(Boolean).join(" / ");return e.jsxs(b,{style:{gap:12},children:[e.jsx(v,{areaList:m,value:t,onChange:n,title:"受控模式"}),e.jsx(z,{readOnly:!0,label:"选择结果",value:i}),e.jsx(M,{text:"切换至上海",onPress:()=>n(["310000","310100","310101"])})]})}const j=({title:t,children:n})=>e.jsxs(b,{style:f.section,children:[e.jsx(w,{style:f.title,children:t}),n]});function L(){return e.jsxs(b,{style:f.list,children:[e.jsx(j,{title:"基础用法",children:e.jsx(H,{})}),e.jsx(j,{title:"列数切换",children:e.jsx(W,{})}),e.jsx(j,{title:"受控模式",children:e.jsx(G,{})})]})}const f=R.create({list:{gap:16},section:{gap:12},title:{fontSize:14,color:"#323233",fontWeight:"600"}}),K=`import React from 'react'
...
`,U={code:K,sources:{_:{tsx:`import React from 'react'
import { Platform, StyleSheet, Text, View } from 'react-native'
...
`}},title:!0,identifier:"area-basic",lang:"tsx",meta:{title:!0}}],Q={simulator:{compact:!0}},X=[{depth:1,text:"Area 省市区",id:"area-省市区"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:2,text:"API",id:"api"},{depth:3,text:"Area Props",id:"area-props"},{depth:3,text:"AreaList 格式",id:"arealist-格式"}],Y="/docs/components/area.md",Z="Area 省市区",$="1769570039000",Ne=t=>t.children({MdContent:q,demos:J,frontmatter:Q,slugs:X,filePath:Y,title:Z,updatedTime:$});export{q as MdContent,Ne as default,J as demos,Y as filePath,Q as frontmatter,X as slugs,Z as title,$ as updatedTime};
