import{R as u,a3 as d,r,j as e,V as a,a as h,s as le,F as ue}from"./main-BXb8DOxl.js";import{e as b,b as A,S as B,a as k,c as V,d as de}from"./Wechat-BQ1epNrx.js";import{C as v}from"./index-BSmhLq_l.js";import{a as he}from"./hairline-BrrexFH9.js";import{P as pe}from"./Popup-CKHRlZsm.js";import{c as me,T as p}from"./createComponentTokensHook-C7GS3cUR.js";import{M as H}from"./index-DkTYenKX.js";import{u as $}from"./useAriaPress-6bm6-278.js";import{I as E}from"./Image-BkUMp8ay.js";import"./IconBase-5wkEN6D1.js";import"./Arrow-D1qxk6Xz.js";import"./createPlatformShadow-BbOkyb5V.js";import"./Portal-DNoXqwcq.js";import"./Animated-BshxiKK9.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./index-ZIcEKt2e.js";import"./index-CysvSvJu.js";import"./index-BPY4IQIH.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-VZ9qA3Du.js";import"./index-4Yp_2FWl.js";import"./SafeAreaView-DgWhFFT_.js";import"./useSafeAreaPadding-C6K9c3C6.js";import"./index-9yrhdMQu.js";const xe=t=>{const{palette:i,spacing:n,fontSize:o}=t;return{colors:{background:"#ffffff",title:i.default[900],description:i.default[500],option:i.default[900],optionDesc:i.default[500],border:i.default[200],divider:i.default[100]},spacing:{horizontal:n.md,vertical:n.sm,gap:n.xs,popupPadding:0,headerPaddingTop:n.sm,headerPaddingHorizontal:n.lg,headerPaddingBottom:n.md,titleMarginTop:n.xs,descriptionMarginTop:n.xs,nodeMarginTop:n.xs,iconMarginHorizontal:n.md,optionTextPaddingHorizontal:n.xs,optionDescPaddingHorizontal:n.lg,cancelPaddingVertical:14,cancelMarginTop:n.sm},sizing:{icon:48},typography:{title:o.md,description:o.xs,option:o.xs,optionDesc:o.xxs,cancel:o.md}}},ge=me("shareSheet",xe),Se=t=>!t||t.length===0?[]:Array.isArray(t[0])?t:[t],fe=u.memo(({option:t,index:i,columns:n,tokens:o,onSelect:x})=>{const j={width:`${100/n}%`},g={width:o.sizing.icon,height:o.sizing.icon},S=$({onPress:()=>x(t,i),extraProps:{accessibilityRole:"button",testID:`rv-share-sheet-item-${i}`}});return e.jsxs(H,{style:[c.option,j],...S.interactionProps,children:[e.jsx(a,{style:[c.icon,g,{marginHorizontal:o.spacing.iconMarginHorizontal}],children:t.icon}),d(t.name)?h(t.name)?e.jsx(p,{style:[c.optionText,{color:o.colors.option,fontSize:o.typography.option,paddingHorizontal:o.spacing.optionTextPaddingHorizontal}],children:t.name}):t.name:null,d(t.description)?h(t.description)?e.jsx(p,{style:[c.optionDesc,{color:o.colors.optionDesc,marginTop:o.spacing.gap,fontSize:o.typography.optionDesc,paddingHorizontal:o.spacing.optionDescPaddingHorizontal}],children:t.description}):e.jsx(a,{style:[c.optionDescNode,{marginTop:o.spacing.gap,paddingHorizontal:o.spacing.optionDescPaddingHorizontal}],children:t.description}):null]})}),be=u.memo(({cancelText:t,tokens:i,onPress:n})=>{const o=$({onPress:n,extraProps:{testID:"rv-share-sheet-cancel",accessibilityRole:"button"}});return e.jsx(a,{style:{backgroundColor:i.colors.divider},children:e.jsx(H,{style:[c.cancel,{backgroundColor:i.colors.background,paddingVertical:i.spacing.cancelPaddingVertical,marginTop:i.spacing.cancelMarginTop}],...o.interactionProps,children:h(t)?e.jsx(p,{style:[c.cancelText,{color:i.colors.option,fontSize:i.typography.cancel}],children:t}):t})})}),ve=t=>{const{visible:i,title:n,description:o,cancelText:x="取消",options:j,columns:g=4,closeOnSelect:S=!0,safeAreaInsetBottom:U=!0,children:X,tokensOverride:Y,onSelect:R,onCancel:M,onClose:O,lockScroll:Z=!0,overlay:ee=!0,round:ne=!0,style:te,placement:we,position:Te,...ie}=t,s=ge(Y),C=Se(j),D=ue(g)?Math.max(1,Math.floor(g)):4,y=d(n),F=d(o),oe=d(x),N=r.useRef(M);N.current=M;const W=r.useRef(O);W.current=O;const z=r.useRef(R);z.current=R;const f=r.useCallback(l=>{l&&N.current?.(),W.current?.()},[]),I=r.useCallback((l,P)=>{z.current?.(l,P),l.onPress?.(l),S&&f()},[f,S]),Q=r.useCallback(()=>f(!0),[f]),se=[c.wrapper,{backgroundColor:s.colors.background}],w=[c.optionsRow,{paddingLeft:s.spacing.gap,paddingVertical:12}],ce=r.useMemo(()=>{if(!C.length)return null;let l=0;return C.map((P,T)=>e.jsxs(a,{children:[T?e.jsx(a,{style:he({position:"top",color:s.colors.border,left:s.spacing.horizontal,right:s.spacing.horizontal})}):null,e.jsx(a,{style:w,children:P.map(_=>{const L=l++;return e.jsx(fe,{option:_,index:L,columns:D,tokens:s,onSelect:I},_.key??L)})})]},T))},[C,w,I,D,s]),ae=r.useMemo(()=>!y&&!F?null:e.jsxs(a,{style:[c.header,{paddingTop:s.spacing.headerPaddingTop,paddingHorizontal:s.spacing.headerPaddingHorizontal,paddingBottom:s.spacing.headerPaddingBottom}],children:[y?h(n)?e.jsx(p,{style:[c.title,{color:s.colors.title,fontSize:s.typography.title,marginTop:s.spacing.titleMarginTop}],children:n}):e.jsx(a,{style:[c.node,{marginTop:s.spacing.nodeMarginTop}],children:n}):null,F?h(o)?e.jsx(p,{style:[c.description,{color:s.colors.description,fontSize:s.typography.description,marginTop:s.spacing.descriptionMarginTop}],children:o}):e.jsx(a,{style:[c.node,{marginTop:s.spacing.nodeMarginTop}],children:o}):null]}),[o,F,y,n,s.colors.description,s.colors.title,s.spacing.descriptionMarginTop,s.spacing.headerPaddingBottom,s.spacing.headerPaddingHorizontal,s.spacing.headerPaddingTop,s.spacing.nodeMarginTop,s.spacing.titleMarginTop,s.typography.description,s.typography.title]),re=[{padding:s.spacing.popupPadding},te];return e.jsx(pe,{...ie,visible:i,placement:"bottom",round:ne,safeAreaInsetBottom:U,overlay:ee,lockScroll:Z,onClose:Q,style:re,children:e.jsxs(a,{style:se,children:[ae,ce,X,oe?e.jsx(be,{cancelText:x,tokens:s,onPress:Q}):null]})})},c=le.create({wrapper:{width:"100%"},header:{alignItems:"center"},title:{fontWeight:"normal",textAlign:"center"},description:{textAlign:"center"},node:{alignItems:"center"},optionsRow:{flexDirection:"row",flexWrap:"wrap"},option:{alignItems:"center",justifyContent:"center"},icon:{alignItems:"center",justifyContent:"center"},optionText:{fontWeight:"500",textAlign:"center"},optionDesc:{textAlign:"center"},optionDescNode:{alignItems:"center"},cancel:{alignItems:"center"},cancelText:{fontWeight:"500"}}),m=u.memo(ve);m.displayName="ShareSheet";const je=[{name:"微信",icon:e.jsx(b,{})},{name:"微博",icon:e.jsx(A,{})},{name:"分享海报",icon:e.jsx(B,{})},{name:"二维码",icon:e.jsx(k,{})}],q=()=>{const[t,i]=u.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(v,{title:"显示分享面板",clickable:!0,isLink:!0,onPress:()=>i(!0)}),e.jsx(m,{visible:t,title:"立即分享给好友",options:je,closeOnSelect:!1,onCancel:()=>i(!1),onSelect:(n,o)=>{console.log("option",n),console.log("index",o),i(!1)}})]})},Ce=`import React from 'react'
...
`}},title:"基础用法",identifier:"share-sheet-basic",lang:"tsx",meta:{title:"基础用法"}},Fe=[[{name:"微信",icon:e.jsx(b,{})},{name:"朋友圈",icon:e.jsx(b,{})},{name:"微博",icon:e.jsx(A,{})},{name:"QQ",icon:e.jsx(V,{})}],[{name:"复制链接",icon:e.jsx(V,{})},{name:"分享海报",icon:e.jsx(B,{})},{name:"二维码",icon:e.jsx(k,{})},{name:"小程序码",icon:e.jsx(de,{})}]],G=()=>{const[t,i]=u.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(v,{title:"显示分享面板",clickable:!0,isLink:!0,onPress:()=>i(!0)}),e.jsx(m,{visible:t,title:"立即分享给好友",options:Fe,closeOnSelect:!1,onCancel:()=>i(!1),onSelect:(n,o)=>{console.log("option",n),console.log("index",o),i(!1)}})]})},Pe=`import React from 'react'
import { Cell, ShareSheet } from 'react-native-system-ui'
...
`}},title:"自定义图标",identifier:"share-sheet-custom",lang:"tsx",meta:{title:"自定义图标"}},ke=[{name:"微信",icon:e.jsx(b,{})},{name:"微博",icon:e.jsx(A,{})},{name:"复制链接",icon:e.jsx(V,{}),description:"描述信息"},{name:"分享海报",icon:e.jsx(B,{})},{name:"二维码",icon:e.jsx(k,{})}],K=()=>{const[t,i]=u.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(v,{title:"显示分享面板",clickable:!0,isLink:!0,onPress:()=>i(!0)}),e.jsx(m,{visible:t,options:ke,title:"立即分享给好友",description:"描述信息",closeOnSelect:!1,onCancel:()=>i(!1),onSelect:(n,o)=>{console.log("option",n),console.log("index",o),i(!1)}})]})},Re=`import React from 'react'
import { Cell, ShareSheet } from 'react-native-system-ui'
...
`,Me={code:Re,sources:{_:{tsx:`import React from 'react'
import { Cell, ShareSheet } from 'react-native-system-ui'
import { Photo, Qr, Share, ShareO, Wechat } from 'react-native-system-icon'
...
`}},title:"基础用法",identifier:"share-sheet-basic",lang:"tsx",meta:{title:"基础用法"}},{Component:G,key:"share-sheet-groups",sources:{_:{tsx:`import React from 'react'
import { Cell, ShareSheet } from 'react-native-system-ui'
import { Photo, Qr, Share, ShareO, WeappNav, Wechat } from 'react-native-system-icon'
