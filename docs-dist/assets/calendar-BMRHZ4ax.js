import{R as p,j as e}from"./main-BXb8DOxl.js";import{C as E}from"./Calendar-BkoRYjSr.js";import{C as h}from"./index-BSmhLq_l.js";import{T as A}from"./index-QxcKJNa1.js";import"./Popup-CKHRlZsm.js";import"./createPlatformShadow-BbOkyb5V.js";import"./IconBase-5wkEN6D1.js";import"./Portal-DNoXqwcq.js";import"./createComponentTokensHook-C7GS3cUR.js";import"./Animated-BshxiKK9.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./index-ZIcEKt2e.js";import"./index-CysvSvJu.js";import"./index-BPY4IQIH.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-VZ9qA3Du.js";import"./useAriaPress-6bm6-278.js";import"./index-4Yp_2FWl.js";import"./index-DkTYenKX.js";import"./SafeAreaView-DgWhFFT_.js";import"./useSafeAreaPadding-C6K9c3C6.js";import"./useControllableValue-B6yjddGc.js";import"./Arrow-D1qxk6Xz.js";import"./hairline-BrrexFH9.js";import"./Loading-C0Kht0oY.js";import"./index-9yrhdMQu.js";import"./Checked-hxCKIkd8.js";import"./Close-BDE-d6Lo.js";const m=n=>n&&(Array.isArray(n)?n.map(l=>new Date(l)):new Date(n)),O=(n,l)=>n?l==="single"?n instanceof Date?n.toLocaleDateString():"请选择日期":l==="multiple"?Array.isArray(n)&&n.length?`共${n.length}个日期`:"请选择日期":Array.isArray(n)&&n.length===2?`${n[0].toLocaleDateString()} ~ ${n[1].toLocaleDateString()}`:"请选择日期":"请选择日期",r=n=>{const{key:l,title:t,type:a="single",showConfirm:i,cellProps:u,initialValue:y,valueFormatter:o,onChange:s,...j}=n,[k,D]=p.useState(!1),[C,V]=p.useState(()=>m(y??null)),[L,f]=p.useState(null),g=i??a!=="single",v=p.useCallback(d=>{f(d?m(C):null),D(d)},[C]),S=p.useCallback(d=>{const c=m(d);f(c),g||(V(c),s?.(c,a))},[g,s,a]),w=p.useCallback(d=>{const c=m(d);V(c),s?.(c,a)},[s,a]),F=o?o(C,a):O(C,a),P=L??C;return{cell:e.jsx(h,{title:t,value:F,isLink:!0,onPress:()=>v(!0),...u},`cell-${l}`),calendar:e.jsx(E,{...j,poppable:!0,type:a,visible:k,value:P??null,showConfirm:g,onVisibleChange:v,onSelect:S,onConfirm:w},`calendar-${l}`)}},x=()=>{const n=r({key:"basic-single",title:"单个日期",showConfirm:!1}),l=r({key:"basic-multiple",title:"多个日期",type:"multiple"}),t=r({key:"basic-range",title:"日期区间",type:"range",cellProps:{titleStyle:{width:96}}}),a=[n,l,t];return e.jsxs(e.Fragment,{children:[e.jsx(h.Group,{title:"基础",card:!0,children:a.map(i=>i.cell)}),a.map(i=>i.calendar)]})},M=`import React from 'react'
