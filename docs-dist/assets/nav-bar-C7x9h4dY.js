import{R as fe,r as w,c as i,j as e,V as o,a as c}from"./main-BuQiU471.js";import{S as pe}from"./ArrowLeft-4WgNc3Io.js";import{c as me}from"./hairline-MnVzd1gq.js";import{c as je,T as v}from"./createComponentTokensHook-BZh_OSSd.js";import{M as I}from"./index-BRfylSA6.js";import{S as ve}from"./SafeAreaView-B7j4syYp.js";import{u as D}from"./useAriaPress-D5uAXibC.js";import{S as ye}from"./Search-BiBiRWIm.js";import"./IconBase-CrFgzAiS.js";import"./extends-CF3RwP-h.js";import"./useSafeAreaPadding-Dnz88xZy.js";import"./index-CJrLMJTa.js";class y{static alert(){}}const ge=({palette:r,spacing:h,fontSize:n})=>({defaults:{fixed:!1,placeholder:!1,border:!0,safeAreaInsetTop:!1,leftArrow:!1,zIndex:1},layout:{container:{width:"100%"},bar:{flexDirection:"row",alignItems:"center",minHeight:48,paddingHorizontal:h.md},center:{flex:1,alignItems:"center",justifyContent:"center",paddingHorizontal:12},side:{minWidth:60,flexDirection:"row",alignItems:"center",gap:4},rightAlign:{justifyContent:"flex-end"},sidePlaceholder:{minWidth:60},sideText:{fontSize:16},titleWrapper:{alignItems:"center"},title:{includeFontPadding:!1},description:{marginTop:2,includeFontPadding:!1},fixed:{position:"absolute",top:0,left:0,right:0}},colors:{background:"#ffffff",text:r.default[900],description:r.default[500],border:r.default[200],icon:r.default[700]},typography:{titleSize:n.lg,titleWeight:"600",descriptionSize:n.sm},sizing:{height:52}}),Ae=je("navBar",ge),Be=r=>{const{tokensOverride:h,title:n,description:x,children:F,leftText:l,rightText:s,leftIcon:E,rightIcon:k,leftArrow:z,fixed:_,placeholder:V,zIndex:H,border:W,safeAreaInsetTop:O,background:$,tintColor:g,titleStyle:q,descriptionStyle:G,sideStyle:f,onPressLeft:J,onClickLeft:K,onPressRight:Q,onClickRight:U,style:X,...Y}=r,t=Ae(h),A=z??t.defaults.leftArrow,B=_??t.defaults.fixed,Z=V??t.defaults.placeholder,ee=H??t.defaults.zIndex,te=W??t.defaults.border,P=O??B,N=$??t.colors.background,p=J??K,m=Q??U,[re,ne]=w.useState(t.sizing.height),b=B&&Z,R=w.useCallback(d=>{if(!b)return;const a=d.nativeEvent.layout.height;ne(u=>Math.abs(u-a)<.5?u:a)},[b]),ie=g??t.colors.text,j=g??t.colors.icon,oe=c(l)?`${l}`:"返回",le=c(s)?`${s}`:"操作",se=D({disabled:!p,onPress:p,extraProps:{accessibilityRole:"button",accessibilityLabel:oe}}),ae=D({disabled:!m,onPress:m,extraProps:{accessibilityRole:"button",accessibilityLabel:le}}),ce=()=>{const d=A===!0?e.jsx(pe,{size:18,fill:j,color:j}):i(A)&&A;if(!(!!p||i(d)||i(l)||i(E)))return e.jsx(o,{style:t.layout.sidePlaceholder});const u=e.jsxs(e.Fragment,{children:[d,E,i(l)?c(l)?e.jsx(v,{numberOfLines:1,style:[t.layout.sideText,{color:j}],children:l}):l:null]});return p?e.jsx(I,{hitSlop:{top:8,right:8,bottom:8,left:8},testID:"rv-navbar-left",style:[t.layout.side,f],...se.interactionProps,children:u}):e.jsx(o,{testID:"rv-navbar-left",style:[t.layout.side,f],children:u})},de=()=>{if(!(!!m||i(s)||i(k)))return e.jsx(o,{style:t.layout.sidePlaceholder});const a=e.jsxs(e.Fragment,{children:[i(s)?c(s)?e.jsx(v,{numberOfLines:1,style:[t.layout.sideText,{color:j}],children:s}):s:null,k]});return m?e.jsx(I,{hitSlop:{top:8,right:8,bottom:8,left:8},testID:"rv-navbar-right",style:[t.layout.side,t.layout.rightAlign,f],...ae.interactionProps,children:a}):e.jsx(o,{testID:"rv-navbar-right",style:[t.layout.side,t.layout.rightAlign,f],children:a})},ue=i(F)?F:e.jsxs(o,{style:t.layout.titleWrapper,children:[i(n)?c(n)?e.jsx(v,{style:[t.layout.title,{color:ie,fontSize:t.typography.titleSize,fontWeight:t.typography.titleWeight},q],numberOfLines:1,children:n}):n:null,i(x)?c(x)?e.jsx(v,{style:[t.layout.description,{color:g??t.colors.description,fontSize:t.typography.descriptionSize},G],numberOfLines:1,children:x}):x:null]}),T=e.jsxs(o,{style:[t.layout.bar,{backgroundColor:N},te?me(t.colors.border):null],onLayout:P?void 0:R,children:[ce(),e.jsx(o,{style:t.layout.center,children:ue}),de()]}),he=P?e.jsx(ve,{onLayout:R,style:{backgroundColor:N},children:T}):T,xe=e.jsx(o,{...Y,style:[t.layout.container,B&&[t.layout.fixed,{zIndex:ee}],X],children:he});return e.jsxs(e.Fragment,{children:[b?e.jsx(o,{testID:"rv-navbar-placeholder",style:{height:re}}):null,xe]})},C=fe.memo(Be);C.displayName="NavBar";const S=()=>e.jsx(o,{style:{height:120,backgroundColor:"#f4f5f7",margin:16,borderRadius:12}}),L=()=>e.jsxs(e.Fragment,{children:[e.jsx(C,{title:"标题",leftText:"返回",leftArrow:!0,rightText:"按钮",onClickLeft:()=>y.alert("点击返回"),onClickRight:()=>y.alert("点击按钮")}),e.jsx(S,{}),e.jsx(S,{})]}),be=`import React from 'react'
...
`}},title:"基础用法",identifier:"nav-bar-basic",lang:"tsx",meta:{title:"基础用法"}},M=()=>e.jsx(C,{title:"标题",leftText:"返回",leftArrow:!0,rightText:e.jsx(ye,{size:20}),onClickLeft:()=>y.alert("点击返回"),onClickRight:()=>y.alert("点击按钮")}),Fe=`import React from 'react'
...
`}},title:"自定义内容",identifier:"nav-bar-custom",lang:"tsx",meta:{title:"自定义内容"}}],Ne={simulator:{compact:!0}},Re=[{depth:1,text:"NavBar 导航栏",id:"navbar-导航栏"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"自定义内容",id:"自定义内容"},{depth:2,text:"API",id:"api"},{depth:3,text:"Props",id:"props"},{depth:3,text:"Events",id:"events"}],Te="/docs/components/nav-bar.md",we="NavBar 导航栏",Ie="1766649452000",Ge=r=>r.children({MdContent:ke,demos:Pe,frontmatter:Ne,slugs:Re,filePath:Te,title:we,updatedTime:Ie});export{ke as MdContent,Ge as default,Pe as demos,Te as filePath,Ne as frontmatter,Re as slugs,we as title,Ie as updatedTime};
