import{R as b,r as v,s as $,j as e,V as c,a as D,c as R}from"./main-BAeJvGa4.js";import{c as W,T as P}from"./createComponentTokensHook-C-NxqfEf.js";import{u as L}from"./useControllableValue-Dp7VzsJy.js";import{m as O}from"./mergeTokensOverride-G6XouRqD.js";import{B as q}from"./Badge-Dky_LxIw.js";import{M as G}from"./index-DkwLlxr6.js";import{u as J}from"./useAriaPress-B7BjoQga.js";import{T as k}from"./index-DyP2Y3u_.js";import"./number-D4GYRO_w.js";import"./extends-CF3RwP-h.js";import"./index-CJrLMJTa.js";import"./Portal-DpGMOUoW.js";import"./Overlay-DsrHAOal.js";import"./Loading-CpmDHEQC.js";import"./index-tIQ9IWf_.js";import"./Checked-Cm_Ob0Fm.js";import"./IconBase-BXXvwLgA.js";import"./Close-Cz6HpK28.js";import"./index-DNlyIA0F.js";import"./index-Beiuxnvg.js";import"./Animated-BC0ZtReY.js";import"./index-BQ9E3_S9.js";import"./index-OVYHKMmk.js";import"./SafeAreaView-DvA24sN_.js";import"./useSafeAreaPadding-CHurfSaN.js";import"./useOverlayStack-D2UM4R66.js";import"./animation-BpxpeSKC.js";const V=b.createContext(null),K=()=>v.useContext(V),Q=a=>{const{palette:r,fontSize:i,typography:p}=a,u=$.hairlineWidth;return{defaults:{disabled:!1},layout:{container:{flexDirection:"row"},side:{borderRightWidth:u},content:{flex:1,minWidth:0},item:{flexDirection:"row",alignItems:"center",paddingHorizontal:16},indicatorWrapper:{width:12,alignItems:"center"},itemContent:{flex:1,paddingVertical:12},indicator:{height:20},titleRow:{flexDirection:"row",alignItems:"center",gap:8},badge:{marginLeft:4},dot:{width:6,height:6,borderRadius:3},title:{includeFontPadding:!1}},colors:{background:"#ffffff",border:r.default[200],title:r.default[800],titleActive:r.primary[600],disabled:r.default[400],indicator:r.primary[600]},typography:{fontSize:i.sm,fontWeight:p.weight.medium},sizing:{width:120,itemHeight:48,indicatorWidth:4},borders:{width:u}}},_=W("sidebar",Q),M=a=>{const{children:r,sideStyle:i,style:p,tokensOverride:u,...F}=a,h=_(u),s=v.useMemo(()=>{const d=[],o=b.Children.toArray(r);for(let m=0;m<o.length;m++){const I=o[m];b.isValidElement(I)&&d.push({element:I,index:m})}return d},[r]),y=s[0]?.index??0,[S,x]=L(a,{defaultValue:y,valuePropName:"value",defaultValuePropName:"defaultValue",trigger:"onChange"}),g=v.useMemo(()=>{let d=y;for(let o=0;o<s.length;o++)if(s[o].index===S){d=S;break}return d},[S,y,s]),C=v.useMemo(()=>({activeIndex:g,onSelect:x}),[g,x]),A=v.useMemo(()=>s.map(d=>{const o=d.element.key??d.index,m=O(u,d.element.props.tokensOverride);return b.cloneElement(d.element,{key:o,index:d.index,tokensOverride:m})}),[s,u]),t=s.find(d=>d.index===g)?.element,f=t?.props?.contentStyle,l=t?.props?.children,j=l==null||l===!1?null:D(l)?e.jsx(P,{children:l}):l,E=[h.layout.container,{backgroundColor:h.colors.background},p],B=[h.layout.side,{width:h.sizing.width,borderRightColor:h.colors.border},i];return e.jsxs(c,{...F,style:E,children:[e.jsx(c,{style:B,accessibilityRole:"tablist",children:e.jsx(V.Provider,{value:C,children:A})}),e.jsx(c,{style:[h.layout.content,f],children:j})]})};M.displayName="Sidebar";const T=a=>{const{title:r,badge:i,disabled:p,dot:u,onClick:F,textStyle:h,badgeStyle:s,contentStyle:y,style:S,index:x=0,children:g,tokensOverride:C,...A}=a,t=_(C),f=K();if(!f)return null;const l=p??t.defaults.disabled,j=f.activeIndex===x,E=l?t.colors.disabled:j?t.colors.titleActive:t.colors.title,B=J({disabled:l,onPress:()=>{F?.(x),f.onSelect(x)},extraProps:{accessibilityRole:"tab",accessibilityState:{selected:j,disabled:l},testID:`rv-sidebar-item-${x}`}}),d=[t.layout.indicator,{width:t.sizing.indicatorWidth,borderRadius:t.sizing.indicatorWidth,backgroundColor:t.colors.indicator}],o=R(r)?D(r)?e.jsx(P,{style:[t.layout.title,{color:E,fontSize:t.typography.fontSize,fontWeight:t.typography.fontWeight},h],children:r}):r:null,m=R(i)?e.jsx(c,{style:[t.layout.badge,s],children:D(i)?e.jsx(q,{content:i}):i}):null,I=u?e.jsx(c,{style:[t.layout.dot,{backgroundColor:t.colors.indicator}]}):null;return e.jsxs(G,{...A,...B.interactionProps,style:[t.layout.item,{height:t.sizing.itemHeight},S],children:[e.jsx(c,{style:t.layout.indicatorWrapper,children:j&&e.jsx(c,{style:d})}),e.jsx(c,{style:t.layout.itemContent,children:e.jsxs(c,{style:t.layout.titleRow,children:[o,m,I]})})]})};T.displayName="Sidebar.Item";const n=Object.assign(M,{Item:T}),z=()=>e.jsxs(n,{defaultValue:0,style:{height:200},children:[e.jsx(n.Item,{title:"标签名1"}),e.jsx(n.Item,{title:"标签名2"}),e.jsx(n.Item,{title:"标签名3"})]}),U=`import React from 'react'
...
`}},title:"徽标与禁用",identifier:"sidebar-custom",lang:"tsx",meta:{title:"徽标与禁用"}},w=()=>{const[a,r]=b.useState(2);return e.jsxs(n,{value:a,onChange:i=>{r(i),k.info(`标签名 ${i+1}`)},style:{height:200},children:[e.jsx(n.Item,{title:"标签名1"}),e.jsx(n.Item,{title:"标签名2"}),e.jsx(n.Item,{title:"标签名3"})]})},ee=`import React from 'react'
