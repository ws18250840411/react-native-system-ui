import{s as W,R as xe,r as E,D as a,d as pe,j as e,V as l}from"./main-BuQiU471.js";import{c as ye,T as je}from"./createComponentTokensHook-BZh_OSSd.js";import{u as me}from"./index-COVjMqe7.js";import{I as fe}from"./index-Ct6-Nt5P.js";import{T as S}from"./Typography-C0C-_2nD.js";import"./index-BAZkLH96.js";import"./extends-CF3RwP-h.js";import"./index-CJrLMJTa.js";const ge=r=>{const{palette:i}=r;return{defaults:{content:"WaterMark",width:120,height:64,gapX:24,gapY:48,rotate:-22,fontSize:14,opacity:.15,zIndex:2e3,fullPage:!0},layout:{absoluteFill:W.absoluteFillObject,wrapper:{flex:1},row:{flexDirection:"row"},cell:{alignItems:"center",justifyContent:"center"},mark:{alignItems:"center",justifyContent:"center"}},colors:{mark:i.default[500]}}},Fe=ye("waterMark",ge),c=(r,i)=>a(r)?r:i,b=(r,i)=>Math.max(0,c(r,i)),N=(r,i)=>Math.max(1,c(r,i)),Ce=r=>{const{content:i,width:u,height:A,gapX:D,gapY:z,rotate:R,image:x,font:s,fontSize:I,color:_,opacity:L,zIndex:V,fullPage:O,tokensOverride:U,style:$,onLayoutCalculated:m,textStyle:X,...Y}=r,t=Fe(U),H=i??t.defaults.content,G=c(V,t.defaults.zIndex),h=O??t.defaults.fullPage,n=me(),[q,J]=E.useState({width:0,height:0}),f=E.useRef({width:0,height:0}),p=h?n:q,K=b(D,t.defaults.gapX),Q=b(z,t.defaults.gapY),Z=c(R,t.defaults.rotate),w=Math.max(0,Math.min(1,c(L,t.defaults.opacity))),T=a(s?.size)?s.size:pe(s?.size)?Number.parseFloat(s.size):void 0,ee=Math.max(0,c((Number.isFinite(T??Number.NaN)?T:void 0)??I,t.defaults.fontSize)),te=s?.color??_??t.colors.mark,g=N(x?.width??u,t.defaults.width),F=N(x?.height??A,t.defaults.height),C=Math.max(1,g+K),M=Math.max(1,F+Q),re=p.height?Math.ceil(p.height/M)+1:1,ie=p.width?Math.ceil(p.width/C)+1:1,ne=o=>{if(h)return;const{width:d,height:k}=o.nativeEvent.layout;if(!a(d)||!a(k))return;const y=Math.max(0,d),j=Math.max(0,k);f.current.width===y&&f.current.height===j||(f.current={width:y,height:j},J({width:y,height:j}),m?.({width:y,height:j}))};E.useEffect(()=>{h&&(!a(n.width)||!a(n.height)||n.width<=0||n.height<=0||m?.({width:n.width,height:n.height}))},[h,m,n.width,n.height]);const de={zIndex:G},se={width:C,height:M},oe={paddingLeft:C/2},ae={width:g,height:F,transform:[{rotate:`${Z}deg`}]},le={width:g,height:F,opacity:w},ce={fontSize:ee,color:te,opacity:w,fontFamily:s?.family,fontWeight:s?.weight},ue=Array.from({length:re},(o,d)=>d),he=Array.from({length:ie},(o,d)=>d);return e.jsx(l,{pointerEvents:"none",style:[h?t.layout.absoluteFill:null,de,$],onLayout:ne,...Y,children:e.jsx(l,{style:t.layout.wrapper,children:ue.map(o=>e.jsx(l,{style:[t.layout.row,o%2===0?null:oe],children:he.map(d=>e.jsx(l,{style:[t.layout.cell,se],children:e.jsx(l,{style:[t.layout.mark,ae],children:x?e.jsx(fe,{source:{uri:x.src},style:le,resizeMode:"contain"}):e.jsx(je,{allowFontScaling:!1,style:[ce,X],children:H})})},`col-${o}-${d}`))},`row-${o}`))})})},v=xe.memo(Ce);v.displayName="WaterMark";const B=()=>e.jsx(v,{content:"RNSU"}),Ee=`import React from 'react'
...
`,Te={code:we,sources:{_:{tsx:`import React from 'react'
import { WaterMark, Typography } from 'react-native-system-ui'
import { View, StyleSheet } from 'react-native'
...
`}},title:"局部覆盖",identifier:"water-mark-custom",lang:"tsx",meta:{title:"局部覆盖"}}],Se={simulator:{compact:!1}},be=[{depth:1,text:"WaterMark 水印",id:"watermark-水印"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"全屏水印",id:"全屏水印"},{depth:3,text:"区域水印",id:"区域水印"},{depth:2,text:"API",id:"api"}],Ne="/docs/components/water-mark.md",We="WaterMark 水印",Be="1766057058000",Ve=r=>r.children({MdContent:Me,demos:ke,frontmatter:Se,slugs:be,filePath:Ne,title:We,updatedTime:Be});export{Me as MdContent,Ve as default,ke as demos,Ne as filePath,Se as frontmatter,be as slugs,We as title,Be as updatedTime};
