import{r as n,i as L,R as P,b as $,j as e,V as H,a as W,s as O}from"./main-BaO0UwhN.js";import{c as q,T as D}from"./createComponentTokensHook-CsVvHGcO.js";import{f as G}from"./date-DjZXGQxL.js";import{B as A}from"./index-BoPciRW_.js";import{S as b}from"./Space-DQzTpaN5.js";import"./color-CFPOWA-O.js";import"./number-C0AOJ3fJ.js";import"./createPlatformShadow-BbOkyb5V.js";import"./index-CJrLMJTa.js";import"./useAriaPress-vCycRA2r.js";import"./index-DvDeiqEs.js";import"./extends-CF3RwP-h.js";import"./index-B5BUYRhk.js";const R=t=>{const o=Math.max(t,0),r=Math.floor(o/(1440*60*1e3)),d=Math.floor(o%(1440*60*1e3)/(3600*1e3)),x=Math.floor(o%(3600*1e3)/(60*1e3)),h=Math.floor(o%(60*1e3)/1e3),f=o%1e3;return{total:o,days:r,hours:d,minutes:x,seconds:h,milliseconds:f}},J=t=>{const{time:o,millisecond:r=!1,onChange:d,onFinish:x}=t,h=n.useRef(o),f=n.useRef(r),F=n.useRef(d),E=n.useRef(x);h.current=o,f.current=r,F.current=d,E.current=x;const l=n.useRef(Math.max(0,o)),p=n.useRef(Date.now()+l.current),j=n.useRef(null),c=n.useRef(!1),[v,S]=n.useState(()=>R(l.current)),i=n.useCallback(()=>{j.current&&(clearTimeout(j.current),j.current=null)},[]),g=n.useCallback(s=>{l.current=s;const u=R(s);S(u),F.current?.(u),s===0&&(c.current=!1,i(),E.current?.())},[i]),a=n.useCallback(()=>{if(!c.current)return;i();const s=Math.max(p.current-Date.now(),0);if(g(s),s<=0)return;const u=f.current?Math.max(1,Math.min(30,s)):Math.max(1,Math.min(s,s%1e3+1));j.current=setTimeout(()=>{a()},u)},[i,g]),y=n.useCallback(()=>{c.current||l.current<=0||(c.current=!0,p.current=Date.now()+l.current,a())},[a]),m=n.useCallback(()=>{c.current&&(c.current=!1,l.current=Math.max(p.current-Date.now(),0),i())},[i]),B=n.useCallback(s=>{m();const u=Math.max(0,L(s)?s:h.current);l.current=u,p.current=Date.now()+u,S(R(u))},[m]);return n.useEffect(()=>()=>i(),[i]),{start:y,pause:m,reset:B,current:v}},K=t=>{const{palette:o,fontSize:r,typography:d}=t,x=r.sm;return{defaults:{autoStart:!0,millisecond:!1,time:0,format:"HH:mm:ss"},layout:{text:{color:o.default[800],fontSize:x,lineHeight:20,fontFamily:d.fontFamily,fontWeight:d.weight.regular}}}},Q=q("countDown",K),w=P.forwardRef((t,o)=>{const{tokensOverride:r,autoStart:d,millisecond:x,time:h,format:f,children:F,onChange:E,onFinish:l,style:p,...j}=t,c=Q(r),v=d??c.defaults.autoStart,S=x??c.defaults.millisecond,i=h??c.defaults.time,g=f??c.defaults.format,a=Math.max(0,Number(i)||0),{start:y,pause:m,reset:B,current:s}=J({time:a,millisecond:S,onChange:E,onFinish:l}),u=n.useCallback(()=>{B(a),v&&a>0&&y()},[v,a,B,y]);n.useEffect(()=>(u(),()=>{m()}),[v,a,m,B,y]),n.useImperativeHandle(o,()=>({start:y,pause:m,reset:u}));const V=c.layout.text,T=$(F)?F(s):G(g,s),z=W(T)?e.jsx(D,{style:V,children:T}):T;return e.jsx(H,{style:p,...j,children:z})});w.displayName="CountDown";const k=()=>e.jsx(w,{time:1800*60*1e3}),U=`import React from 'react'
...
export default () => <CountDown time={30 * 60 * 60 * 1000} />
`}},title:"基础用法",identifier:"count-down-basic",lang:"tsx",meta:{title:"基础用法"}},M=()=>e.jsx(w,{time:1800*60*1e3,format:"DD 天 HH 时 mm 分 ss 秒"}),Y=`import React from 'react'
import { CountDown } from 'react-native-system-ui'
...
`}},title:"自定义格式",identifier:"count-down-format",lang:"tsx",meta:{title:"自定义格式"}},_=()=>e.jsx(w,{time:1800*60*1e3,millisecond:!0,format:"HH:mm:ss:SS"}),ee=`import React from 'react'
import { CountDown } from 'react-native-system-ui'
...
`}},title:"毫秒级渲染",identifier:"count-down-millisecond",lang:"tsx",meta:{title:"毫秒级渲染"}},C=O.create({row:{flexDirection:"row",alignItems:"center"},block:{minWidth:28,paddingVertical:6,paddingHorizontal:6,borderRadius:6,backgroundColor:"#1989fa",color:"#ffffff",textAlign:"center"},colon:{marginHorizontal:4,color:"#1989fa"}}),I=()=>e.jsx(w,{time:1800*60*1e3,millisecond:!0,format:"HH:mm:ss:SS",children:t=>e.jsxs(H,{style:C.row,children:[e.jsx(D,{style:C.block,children:t.hours}),e.jsx(D,{style:C.colon,children:":"}),e.jsx(D,{style:C.block,children:t.minutes}),e.jsx(D,{style:C.colon,children:":"}),e.jsx(D,{style:C.block,children:t.seconds})]})}),ne=`import React from 'react'
...
`}},title:"自定义样式",identifier:"count-down-custom-style",lang:"tsx",meta:{title:"自定义样式"}},N=()=>{const t=P.useRef(null);return e.jsxs(b,{direction:"vertical",gap:8,children:[e.jsx(w,{ref:t,autoStart:!1,time:60*1e3,format:"mm:ss"}),e.jsxs(b,{gap:8,children:[e.jsx(A,{text:"开始",onPress:()=>t.current?.start()}),e.jsx(A,{text:"暂停",onPress:()=>t.current?.pause()}),e.jsx(A,{text:"重置",onPress:()=>t.current?.reset()})]})]})},oe=`import React from 'react'
...
export default () => <CountDown time={30 * 60 * 60 * 1000} />
`}},title:"基础用法",identifier:"count-down-basic",lang:"tsx",meta:{title:"基础用法"}},{Component:M,key:"count-down-format",sources:{_:{tsx:`import React from 'react'
import { CountDown } from 'react-native-system-ui'
...
`}},title:"自定义格式",identifier:"count-down-format",lang:"tsx",meta:{title:"自定义格式"}},{Component:_,key:"count-down-millisecond",sources:{_:{tsx:`import React from 'react'
import { CountDown } from 'react-native-system-ui'
...
`}},title:"毫秒级渲染",identifier:"count-down-millisecond",lang:"tsx",meta:{title:"毫秒级渲染"}},{Component:I,key:"count-down-custom-style",sources:{_:{tsx:`import React from 'react'
import { StyleSheet, Text, View } from 'react-native'
...
`}},title:"自定义样式",identifier:"count-down-custom-style",lang:"tsx",meta:{title:"自定义样式"}},{Component:N,key:"count-down-ref",sources:{_:{tsx:`import React from 'react'
import { Button, CountDown, Space, type CountDownInstance } from 'react-native-system-ui'
