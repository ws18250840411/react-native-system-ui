import{j as e,R as c,r as E,V as g,a as Ee,b as Ne,d as Te}from"./main-CX5QgiXt.js";import{C as u}from"./index-D361XNui.js";import{P as v}from"./Portal-BtmwX5Pt.js";import{c as _e,T as He}from"./createComponentTokensHook-Hc3l7riF.js";import{u as Oe}from"./useSafeAreaPadding-Du1CT4G_.js";import{A as w,E as L}from"./Animated-rPtBS5kg.js";import{M as Se}from"./index-CQ2P49YQ.js";import{u as ze}from"./useOverlayStack-CF7tueuh.js";import{n as je}from"./animation-BpxpeSKC.js";import{u as Ve}from"./useAriaPress-sIRcrStb.js";import"./Arrow-CFMZgj_G.js";import"./IconBase-D_kjvpJY.js";import"./hairline-6DGjxZ3L.js";import"./Overlay-uC1_KEGM.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./index-BEnr4R_B.js";import"./index-CTcRCRb2.js";import"./index-BDzwQtXM.js";const $e=t=>({defaults:{type:"primary",position:"top",duration:3e3,closeOnClick:!1,animationDuration:180,safeAreaInsetTop:!0,safeAreaInsetBottom:!0},layout:{portal:{position:"absolute",left:0,right:0,position:"fixed"},container:{width:"100%"},safeArea:{width:"100%"},content:{width:"100%",justifyContent:"center"},text:{textAlign:"center",includeFontPadding:!1}},colors:{variants:{primary:{background:t.palette.primary[500],text:t.palette.primary.foreground??"#ffffff"},success:{background:t.palette.success[500],text:t.palette.success.foreground??"#ffffff"},danger:{background:t.palette.danger[500],text:t.palette.danger.foreground??"#ffffff"},warning:{background:t.palette.warning[500],text:t.palette.warning.foreground??"#261400"}}},typography:{fontSize:t.fontSize.sm,lineHeight:Math.round(t.fontSize.sm*t.typography.lineHeightMultiplier)},sizing:{minHeight:35},spacing:{paddingVertical:t.spacing.ssm,paddingHorizontal:t.spacing.md,none:t.spacing.none}}),qe=_e("notify",$e),te=t=>{const{visible:i,message:s,type:o,duration:f,position:d,offset:m,color:_,background:y,zIndex:D,closeOnClick:N,style:se,textStyle:oe,tokensOverride:be,onClick:H,onClose:A,onOpen:re,onOpened:O,onClosed:ue}=t,n=qe(be),le=Oe({top:0,bottom:0}),we=o??n.defaults.type,l=d??n.defaults.position,S=N??n.defaults.closeOnClick,Le=t.safeAreaInsetTop??(l==="top"?n.defaults.safeAreaInsetTop:!1),z=t.safeAreaInsetBottom??(l==="bottom"?n.defaults.safeAreaInsetBottom:!1),V=Le&&l==="top"?le.paddingTop:0,$=z&&l==="bottom"?le.paddingBottom:0,j=typeof m=="number"&&Number.isFinite(m)?Math.max(0,m):0,q=(r,h)=>typeof r=="string"?`calc(${r} + ${h}px)`:r+h,ce=z&&l==="bottom"&&typeof $=="number"?$+j:j,de=l==="top"?q(V,j):void 0,Z=z&&l==="bottom"?q($,j):void 0,ae=n.colors.variants[we],fe=y??ae.background,pe=_??ae.text,K=f??n.defaults.duration,[Y,Re]=c.useState(0),he=E.useCallback(r=>{const h=r.nativeEvent.layout.height;h&&Re(b=>b===h?b:h)},[]),J=Y>0,[k,Q]=c.useState(i),p=c.useRef(new w.Value(0)).current,C=c.useRef(null),U=c.useRef(0),{zIndex:Ge}=ze({visible:k,type:"notify",zIndex:D}),W=Ge??D,X=c.useRef(i),B=c.useRef(!1);c.useEffect(()=>{U.current+=1;const r=U.current;C.current?.stop();const h=n.defaults.animationDuration;if(i){if(Q(!0),!J){p.setValue(0);return}C.current=w.timing(p,{toValue:1,duration:h,easing:L.out(L.cubic),useNativeDriver:je,isInteraction:!1}),C.current.start()}else{if(!J){p.setValue(0),Q(!1);return}C.current=w.timing(p,{toValue:0,duration:h,easing:L.out(L.cubic),useNativeDriver:je,isInteraction:!1}),C.current.start(({finished:b})=>{!b||r!==U.current||Q(!1)})}},[p,J,n.defaults.animationDuration,i]),c.useEffect(()=>()=>{C.current?.stop()},[]),c.useEffect(()=>{let r=null;return i?(B.current=!1,X.current||(re?.(),O&&(r=setTimeout(O,n.defaults.animationDuration)))):X.current&&(B.current=!0),X.current=i,()=>{r&&clearTimeout(r)}},[re,O,n.defaults.animationDuration,i]),c.useEffect(()=>{!k&&B.current&&(B.current=!1,ue?.())},[k,ue]),c.useEffect(()=>{let r=null;return i&&K>0&&(r=setTimeout(()=>{A?.()},K)),()=>{r&&clearTimeout(r)}},[A,K,i]);const F=Y>0?Y:n.sizing.minHeight,x=S||Ne(H),Ie=E.useCallback(()=>{H?.(),S&&A?.()},[S,H,A]),ee=x?"button":"alert",Me=Ve({disabled:!x,onPress:Ie,extraProps:{accessibilityRole:ee,accessibilityLiveRegion:"assertive"}}),me=E.useMemo(()=>l==="bottom"?p.interpolate({inputRange:[0,1],outputRange:[F,0]}):p.interpolate({inputRange:[0,1],outputRange:[-F,0]}),[p,F,l]),xe=s!=null&&s!==!1&&s!=="",ye=E.useMemo(()=>e.jsxs(g,{style:[n.layout.container,l==="top"?{paddingTop:de??q(V,j)}:null,Z!==void 0?{paddingBottom:Z}:null],children:[e.jsx(g,{style:{height:F,overflow:"hidden"},children:e.jsx(w.View,{testID:"rv-notify-bar",accessibilityRole:x?void 0:ee,accessibilityLiveRegion:x?void 0:"assertive",onLayout:he,style:[n.layout.container,{opacity:p,transform:[{translateY:me}]},se],children:e.jsx(g,{style:{backgroundColor:fe},children:e.jsx(g,{style:[n.layout.content,{paddingHorizontal:n.spacing.paddingHorizontal,paddingVertical:n.spacing.paddingVertical,minHeight:n.sizing.minHeight}],children:xe?Ee(s)?e.jsx(He,{style:[n.layout.text,{color:pe,fontSize:n.typography.fontSize,lineHeight:n.typography.lineHeight},oe],children:s}):s:null})})})}),l==="bottom"?e.jsx(g,{style:{height:ce}}):null]}),[ee,p,F,he,xe,x,s,j,n.spacing.paddingVertical,l,fe,pe,ce,V,se,oe,n.layout.container,n.layout.content,n.layout.text,n.sizing.minHeight,n.spacing.paddingHorizontal,n.typography.fontSize,n.typography.lineHeight,me,Z,de]);return k?e.jsx(g,{testID:"rv-notify",pointerEvents:x?"box-none":"none",style:[n.layout.portal,l==="bottom"?{bottom:0}:{top:0},W!=null?{zIndex:W}:null],children:x?e.jsx(Se,{...Me.interactionProps,disabled:!x,children:ye}):ye}):null},Fe=t=>e.jsx(v,{children:e.jsx(te,{...t})});te.displayName="NotifyContent";Fe.displayName="Notify";const M=new Set,R=new Map,T=new Map;let Pe=!1;const ne={type:"primary",position:"top",duration:3e3,safeAreaInsetTop:!0,safeAreaInsetBottom:!0};let G={...ne};const I=new Map,Ce=t=>c.isValidElement(t)||Ee(t)?{message:t}:t??{},Ze=(t,i)=>{const s=t.type??i,o={...G,...I.get(s)},f={...o,...t,type:s};return f.duration=f.duration??o.duration??3e3,f},ie=t=>{v.remove(t),M.delete(t),R.delete(t),T.delete(t)},ve=t=>{const i=T.get(t);i?i.close():ie(t)},ge=({id:t,options:i})=>{const[s,o]=E.useState(!0);E.useEffect(()=>(T.set(t,{close:()=>o(!1)}),()=>{T.delete(t)}),[t]);const f=()=>{i.onClose?.(),o(!1)},d=()=>{i.onClosed?.(),ie(t)};return e.jsx(te,{...i,visible:s,onClose:f,onClosed:d})},P=(t,i="primary")=>{const s=Ze(Ce(t),i);Pe||Array.from(M).forEach(d=>ie(d));const o=v.add(null);R.set(o,s),v.update(o,e.jsx(ge,{id:o,options:s})),M.add(o);const f=d=>{const m=R.get(o);if(!m)return;const _=Ne(d)?d(m):d,y=Ce(_),D=y.type??m.type??i,N={...m,...y,type:D};"duration"in y&&y.duration==null&&(N.duration=ne.duration),R.set(o,N),v.update(o,e.jsx(ge,{id:o,options:N}))};return{clear:()=>ve(o),update:d=>f(d),config:f}},Ke={show:t=>P(t),primary:t=>P(t,"primary"),success:t=>P(t,"success"),danger:t=>P(t,"danger"),warning:t=>P(t,"warning"),clear:()=>{M.forEach(t=>ve(t))},allowMultiple:(t=!0)=>{Pe=t},setDefaultOptions:(t,i)=>{Te(t)?I.set(t,i??{}):G={...G,...t}},resetDefaultOptions:t=>{t?I.delete(t):(G={...ne},I.clear())}},a=Object.assign(Fe,Ke);function De(){return e.jsxs(u.Group,{children:[e.jsx(u,{title:"显示通知",isLink:!0,onPress:()=>a.show("提示内容")}),e.jsx(u,{title:"底部通知",isLink:!0,onPress:()=>a.show({message:"底部提示",position:"bottom"})}),e.jsx(u,{title:"底部通知（偏移）",isLink:!0,onPress:()=>a.show({message:"底部偏移",position:"bottom",offset:12})})]})}const Ye=`import React from 'react'
...
`,Je={code:Ye,sources:{_:{tsx:`import React from 'react'
...
`}},title:"动态更新",identifier:"notify-duration",lang:"tsx",meta:{title:"动态更新"}};function Be(){return e.jsx(u.Group,{children:e.jsx(u,{title:"自定义背景色",isLink:!0,onPress:()=>a.show({message:"自定义样式",color:"#ffffff",background:"#722ed1"})})})}const et=`import React from 'react'
...
`}},title:"自定义颜色",identifier:"notify-custom",lang:"tsx",meta:{title:"自定义颜色"}},nt=function({previewer:t=()=>null,api:i=()=>null}){const s=t;return e.jsx("div",{children:e.jsxs("div",{children:[e.jsx("h1",{id:"notify-消息提示","data-anchor":"notify-消息提示",children:"Notify 消息提示"}),e.jsx("h2",{id:"介绍","data-anchor":"介绍",children:"介绍"}),e.jsx("p",{children:"在页面顶部/底部展示通知文案，常用于全局消息提醒。"}),e.jsx("blockquote",{children:e.jsxs("p",{children:["默认情况下 Notify 不会阻止页面交互（不拦截点击/滚动）；当设置 ",e.jsx("code",{children:"onClick"})," 或 ",e.jsx("code",{children:"closeOnClick"})," 时才会响应点击。"]})}),e.jsx("h2",{id:"引入","data-anchor":"引入",children:"引入"}),e.jsx(s,{code:"import { Notify } from 'react-native-system-ui'",lang:"js"}),e.jsx("blockquote",{children:e.jsxs("p",{children:["使用 Notify 前，需在应用根节点包裹 ",e.jsx("strong",{children:"ConfigProvider"})," 或 ",e.jsx("strong",{children:"Portal.Host"}),"，否则弹层无法挂载。推荐使用 ",e.jsx("a",{href:"./config-provider.md",children:"ConfigProvider"}),"。"]})}),e.jsx("h2",{id:"代码演示","data-anchor":"代码演示",children:"代码演示"}),e.jsx("h3",{id:"基础用法","data-anchor":"基础用法",children:"基础用法"}),e.jsx("div",{children:e.jsx(s,{...Je,children:e.jsx(De,{})})}),e.jsx("h3",{id:"通知类型","data-anchor":"通知类型",children:"通知类型"}),e.jsx("div",{children:e.jsx(s,{...Ue,children:e.jsx(Ae,{})})}),e.jsx("h3",{id:"持续展示与动态更新","data-anchor":"持续展示与动态更新",children:"持续展示与动态更新"}),e.jsx("div",{children:e.jsx(s,{...Xe,children:e.jsx(ke,{})})}),e.jsx("h3",{id:"自定义颜色","data-anchor":"自定义颜色",children:"自定义颜色"}),e.jsx("div",{children:e.jsx(s,{...tt,children:e.jsx(Be,{})})}),e.jsx("h3",{id:"静态调用","data-anchor":"静态调用",children:"静态调用"}),e.jsxs("p",{children:["Notify 支持 ",e.jsx("code",{children:"show/primary/success/danger/warning"})," 等静态方法，直接在任意位置调用即可展示通知。"]}),e.jsx(s,{code:`Notify.show('提示内容')
...
`}},title:"自定义颜色",identifier:"notify-custom",lang:"tsx",meta:{title:"自定义颜色"}}],st={simulator:{compact:!0}},ot=[{depth:1,text:"Notify 消息提示",id:"notify-消息提示"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"基础用法",id:"基础用法"},{depth:3,text:"通知类型",id:"通知类型"},{depth:3,text:"持续展示与动态更新",id:"持续展示与动态更新"},{depth:3,text:"自定义颜色",id:"自定义颜色"},{depth:3,text:"静态调用",id:"静态调用"},{depth:2,text:"API",id:"api"},{depth:3,text:"静态方法",id:"静态方法"}],rt="/docs/components/notify.md",ut="Notify 消息提示",lt="1769769521000",kt=t=>t.children({MdContent:nt,demos:it,frontmatter:st,slugs:ot,filePath:rt,title:ut,updatedTime:lt});export{nt as MdContent,kt as default,it as demos,rt as filePath,st as frontmatter,ot as slugs,ut as title,lt as updatedTime};
