...
`}},title:"语言切换",identifier:"config-provider-locale",lang:"tsx",meta:{title:"语言切换"}},E={components:{button:{colors:{tones:{primary:{background:"#8a46ff",border:"#8a46ff",text:"#ffffff"}}}},slider:{track:{height:4},colors:{active:"#8a46ff",inactive:"#e5e8f0"},thumb:{size:22}}}};function h(){const[t,s]=m.useState(60),i=f=>{s(Array.isArray(f)?f[0]:f)};return e.jsx(y,{theme:E,children:e.jsxs(d,{direction:"vertical",gap:16,children:[e.jsxs(n,{style:a.card,children:[e.jsx(r,{style:a.title,children:"定制主题"}),e.jsxs(n,{style:[a.row,a.rowLast],children:[e.jsx(r,{style:a.label,children:"滑块"}),e.jsxs(n,{style:a.sliderControl,children:[e.jsx(S,{value:t,onChange:i,style:{flex:1}}),e.jsx(r,{style:a.value,children:t})]})]})]}),e.jsx(u,{text:"提交",type:"primary",block:!0,round:!0})]})})}const a=c.create({card:{backgroundColor:"#ffffff",borderRadius:18,padding:20},title:{marginBottom:12,fontSize:14,fontWeight:"600",color:"#1d1f2c"},row:{flexDirection:"row",alignItems:"center",paddingVertical:8,borderBottomWidth:c.hairlineWidth,borderBottomColor:"#f0f2f6"},rowLast:{borderBottomWidth:0,paddingBottom:0},label:{fontSize:13,color:"#4a5465",minWidth:48,marginRight:16},sliderControl:{flex:1,flexDirection:"row",alignItems:"center",gap:12},value:{fontSize:12,color:"#475467",minWidth:28,textAlign:"right"}}),P=`import React from 'react'
import { StyleSheet, Text, View } from 'react-native'
...
`,k={code:j,sources:{_:{tsx:`import React from 'react'
import { StyleSheet, Text, View } from 'react-native'
...
`}},title:"实例级 tokensOverride",identifier:"config-provider-tokens-override",lang:"tsx",meta:{title:"实例级 tokensOverride"}}],A={simulator:{compact:!0}},I=[{depth:1,text:"ConfigProvider 全局配置",id:"configprovider-全局配置"},{depth:2,text:"介绍",id:"介绍"},{depth:2,text:"引入",id:"引入"},{depth:2,text:"代码演示",id:"代码演示"},{depth:3,text:"语言切换",id:"语言切换"},{depth:3,text:"定制主题",id:"定制主题"},{depth:3,text:"实例级 tokensOverride（按组件覆盖）",id:"实例级-tokensoverride按组件覆盖"},{depth:2,text:"API",id:"api"},{depth:3,text:"类型定义",id:"类型定义"},{depth:2,text:"差异说明",id:"差异说明"}],D="/docs/components/config-provider.md",L="ConfigProvider 全局配置",W="1770373480000",ie=t=>t.children({MdContent:R,demos:z,frontmatter:A,slugs:I,filePath:D,title:L,updatedTime:W});export{R as MdContent,ie as default,z as demos,D as filePath,A as frontmatter,I as slugs,L as title,W as updatedTime};
