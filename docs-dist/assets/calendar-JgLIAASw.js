import{R as p,j as e}from"./main-O6KZrSH_.js";import{C as E}from"./Calendar-DnRMGEF1.js";import{C as h}from"./index-DCx-GaLs.js";import{T as A}from"./index-CCLXK9-u.js";import"./Popup-DvjP5SkZ.js";import"./createPlatformShadow-BbOkyb5V.js";import"./IconBase-DZr7C-P7.js";import"./Portal-D2qUv7UW.js";import"./Overlay-CmwAk_J5.js";import"./index-CJrLMJTa.js";import"./extends-CF3RwP-h.js";import"./createComponentTokensHook-KzOuLm4c.js";import"./Animated-qBs3E5U6.js";import"./index--voB8Asl.js";import"./index-DcjI-aro.js";import"./index-C_v13XD0.js";import"./animation-BpxpeSKC.js";import"./useOverlayStack-Tvvid2F1.js";import"./useAriaPress-DMjZXFvR.js";import"./index-Cq_gACMg.js";import"./index-DvCZppP1.js";import"./SafeAreaView-L8uUXbhq.js";import"./useSafeAreaPadding-CsLe5OYH.js";import"./useControllableValue-_OJua4RH.js";import"./Arrow-r8D7M_Tx.js";import"./hairline-Dpq7rEkb.js";import"./Loading-CdSfkQu4.js";import"./index-ANZ1PvOD.js";import"./Checked-Cm5uhjGy.js";import"./Close-DpyqkEOI.js";const m=n=>n&&(Array.isArray(n)?n.map(l=>new Date(l)):new Date(n)),O=(n,l)=>n?l==="single"?n instanceof Date?n.toLocaleDateString():"请选择日期":l==="multiple"?Array.isArray(n)&&n.length?`共${n.length}个日期`:"请选择日期":Array.isArray(n)&&n.length===2?`${n[0].toLocaleDateString()} ~ ${n[1].toLocaleDateString()}`:"请选择日期":"请选择日期",r=n=>{const{key:l,title:t,type:a="single",showConfirm:i,cellProps:u,initialValue:y,valueFormatter:o,onChange:s,...j}=n,[k,D]=p.useState(!1),[C,V]=p.useState(()=>m(y??null)),[L,f]=p.useState(null),g=i??a!=="single",v=p.useCallback(d=>{f(d?m(C):null),D(d)},[C]),S=p.useCallback(d=>{const c=m(d);f(c),g||(V(c),s?.(c,a))},[g,s,a]),w=p.useCallback(d=>{const c=m(d);V(c),s?.(c,a)},[s,a]),F=o?o(C,a):O(C,a),P=L??C;return{cell:e.jsx(h,{title:t,value:F,isLink:!0,onPress:()=>v(!0),...u},`cell-${l}`),calendar:e.jsx(E,{...j,poppable:!0,type:a,visible:k,value:P??null,showConfirm:g,onVisibleChange:v,onSelect:S,onConfirm:w},`calendar-${l}`)}},x=()=>{const n=r({key:"basic-single",title:"单个日期",showConfirm:!1}),l=r({key:"basic-multiple",title:"多个日期",type:"multiple"}),t=r({key:"basic-range",title:"日期区间",type:"range",cellProps:{titleStyle:{width:96}}}),a=[n,l,t];return e.jsxs(e.Fragment,{children:[e.jsx(h.Group,{title:"基础",card:!0,children:a.map(i=>i.cell)}),a.map(i=>i.calendar)]})},M=`import React from 'react'
