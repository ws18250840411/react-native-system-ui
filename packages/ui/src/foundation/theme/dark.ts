...
const darken = (value: string) => Color(value).darken(0.3).hex()

const resetColorMap: Partial<TokensType> = {
  brand_6: darken(BASE_TOKENS.brand_6),
  yellow_6: darken(BASE_TOKENS.yellow_6),
  green_6: darken(BASE_TOKENS.green_6),
  red_6: darken(BASE_TOKENS.red_6),
}
