...
export const defaultFoundations: Foundations = {
  palette: {
    ...
    primary: { 50: '#f5f8ff', 100: '#e1e9ff', 200: '#c2d4ff', 300: '#9bb8ff', 400: '#6d94ff', 500: '#4770ff', 600: '#2f51e0', 700: '#243eb1', 800: '#1a2d82', 900: '#111d55', foreground: '#ffffff' },
    info: { 50: '#f0f8ff', 100: '#d9ecff', 200: '#b9dcff', 300: '#8bc3ff', 400: '#5aa7ff', 500: '#328dff', 600: '#1d6fde', 700: '#1753a9', 800: '#113a75', 900: '#0a2143', foreground: '#ffffff' },
    success: { 50: '#f2fbf6', 100: '#dcf5e7', 200: '#b8e9cf', 300: '#8ddbb1', 400: '#5fcf93', 500: '#31c174', 600: '#1da45e', 700: '#128047', 800: '#0a5c32', 900: '#043719', foreground: '#ffffff' },
    warning: { 50: '#fff8ec', 100: '#ffecc7', 200: '#ffd595', 300: '#ffbc63', 400: '#ffa035', 500: '#ff8414', 600: '#d9650b', 700: '#ad4905', 800: '#7f3101', 900: '#4d1c00', foreground: '#ffffff' },
    danger: { 50: '#fff1f2', 100: '#ffd8dd', 200: '#ffadb7', 300: '#ff8090', 400: '#ff556c', 500: '#f2324c', 600: '#ce1733', 700: '#a30f27', 800: '#770819', 900: '#47040b', foreground: '#ffffff' },
  },
