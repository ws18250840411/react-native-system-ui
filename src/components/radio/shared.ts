...
export type RadioAriaProps = AriaRadioProps &
  AccessibilityProps & {
    isRequired?: boolean
    isReadOnly?: boolean
  }

export type RadioGroupAriaProps = AriaRadioGroupProps & { children?: ReactNode }

export const getLabel = (props: { ['aria-label']?: string; label?: unknown }) => {
