...
import Description from 'react-native-system-icon/Description'
import Fail from 'react-native-system-icon/Fail'
import Search from 'react-native-system-icon/Search'
