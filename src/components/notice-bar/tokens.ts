...
export const createNoticeBarTokens = (foundations: Foundations): NoticeBarTokens => {
  ...
  return {
    colors: { text: palette.warning[600], background: palette.warning[50], },
    typography: { fontFamily: typography.fontFamily, fontSize: fontSize.sm, },
    layout: { minHeight: 40, radius: radii.lg, sideMinWidth: 24, },
    spacing: { paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, wrapPaddingVertical: spacing.md, sidePadding: spacing.sm, },
  }
}
