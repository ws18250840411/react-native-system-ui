...
const ShareSheetImpl: React.FC<ShareSheetProps> = p => {
  ...
  const psm = [{ padding: t.spacing.popupPadding }, ps]; return <Popup {...pp} visible={visible} placement="bottom" round={round} safeAreaInsetBottom={safeAreaInsetBottom} overlay={overlay} lockScroll={lockScroll} onClose={opc} style={psm}><View accessibilityRole="menu" style={ws}>{hn}{gn}{children}{hc && <ShareSheetCancel cancelText={cancelText} tokens={t} onPress={opc} />}</View></Popup>
}
