...
class ErrorBoundaryClass extends React.Component<
  ErrorBoundaryProps & { forwardedRef?: React.Ref<ErrorBoundaryRef> },
  ErrorBoundaryState
> {
  static displayName = 'ErrorBoundary'

  constructor(props: ErrorBoundaryProps & { forwardedRef?: React.Ref<ErrorBoundaryRef> }) {
    super(props)
  ...
  private bindRef(): void {
    ...
    if (typeof forwardedRef === 'function') {
      ...
      ;(forwardedRef as React.MutableRefObject<ErrorBoundaryRef | null>).current = refValue
    }
  }
...
const ErrorBoundary = React.forwardRef<ErrorBoundaryRef, ErrorBoundaryProps>(
  (props, ref) => <ErrorBoundaryClass {...props} forwardedRef={ref} />,
)
