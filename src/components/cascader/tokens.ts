...
export const createCascaderTokens = (foundations: Foundations): CascaderTokens => {
  ...
  return {
    ...
    typography: {
      ...
      titleWeight: "500",
      tabsTitleSize: 14,
      tabTitlePlaceholderWeight: "400",
      tabTitleWeight: "500",
      optionTextSize: 14,
      optionTextActiveWeight: "500",
      emptyTextSize: 14,
    },
    sizing: {
      indicatorHeight: 3,
    ...
    spacing: {
      ...
      closeButtonMarginLeft: 8,
      optionLabelMarginRight: 12,
      emptyPaddingVertical: 24,
      inlineChildrenPaddingVertical: 12,
    },
  }
}
