...
import { PortalHost, ensureGlobalPortalHost, portalManager as globalManager } from './PortalHost'
...
export const Portal = Object.assign(PortalComponent, { Host: PortalHost, add, remove, update })
