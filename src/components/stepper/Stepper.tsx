...
const StepperImpl = (props: StepperProps, ref: React.ForwardedRef<StepperInstance>) => {
  ...
  const getButtonTextStyle = useCallback((type: 'plus' | 'minus') => { const isPlus = type === 'plus'; const isDisabled = isPlus ? isPlusDisabled : isMinusDisabled; if (theme === 'round') { const color = isPlus ? tokens.colors.roundThemeText : tokens.colors.roundTheme; return [S.btnTxt, { color, fontFamily: tokens.typography.fontFamily, fontSize: tokens.typography.fontSize, fontWeight: tokens.typography.fontWeight }] }; return [S.btnTxt, { color: isDisabled ? tokens.colors.buttonDisabledIcon : tokens.colors.buttonIcon, fontFamily: tokens.typography.fontFamily, fontSize: tokens.typography.fontSize, fontWeight: tokens.typography.fontWeight }] }, [isMinusDisabled, isPlusDisabled, theme, tokens.colors.buttonDisabledIcon, tokens.colors.buttonIcon, tokens.colors.roundTheme, tokens.colors.roundThemeText, tokens.typography.fontFamily, tokens.typography.fontSize, tokens.typography.fontWeight])
