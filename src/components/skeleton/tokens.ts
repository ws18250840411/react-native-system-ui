...
const createTokens = (foundations: Foundations): SkeletonTokens => {
  ...
  return {
    defaults: { rowCount: 3, rowWidth: '100%', lastRowWidth: '60%', rowHeight: 16, avatarSize: 32, titleWidth: '40%', },
    colors: { block: palette.default[100], highlight: '#ffffff', },
    radius: radii.sm,
    spacing: { containerGap: 12, rowGap: spacing.xs, },
    animation: { duration: 1200, minOpacity: 0.3, maxOpacity: 0.85, },
  }
}
