...
export const createCellTokens = (foundations: Foundations): CellTokens => {
  ...
  return {
    ...
    layout: {
      ...
      containerLarge: {
        ...baseContainerLayout,
        paddingVertical: largePaddingVertical,
      },
      center: {
        alignItems: 'center',
      },
    ...
    colors: {
      background,
      ripple: palette.default[100],
      title: palette.default[800],
      label: palette.default[500],
      value: palette.default[600],
      required: palette.danger[500],
      border: palette.default[200],
      arrow: palette.default[400],
      groupTitle: palette.default[500],
      groupBodyBackground: background,
    },
    typography: {
    ...
    sizing: {
      ...
      arrowSize,
      iconSize,
      groupMarginBottom: spacing.md,
      groupTitlePaddingHorizontal: spacing.lg,
      groupTitlePaddingVertical: spacing.sm,
      groupInsetMarginHorizontal: spacing.lg,
    },
    radii: {
      groupInset: radii.lg,
    },
